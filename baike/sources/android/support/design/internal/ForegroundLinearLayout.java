...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.d = new Rect();
        this.e = new Rect();
        this.f = Constants.WARN_SET_CLIENT_ROLE_NOT_AUTHORIZED;
        this.a = true;
        this.b = false;
    ...
    public void setForegroundGravity(int i) {
        if (this.f != i) {
            ...
            this.f = i2;
            if (this.f == Constants.WARN_SET_CLIENT_ROLE_NOT_AUTHORIZED && this.c != null) {
    ...
    public void setForeground(Drawable drawable) {
        if (this.c != drawable) {
            ...
            if (drawable != null) {
                ...
                if (this.f == Constants.WARN_SET_CLIENT_ROLE_NOT_AUTHORIZED) {
