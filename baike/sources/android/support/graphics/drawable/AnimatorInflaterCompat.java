...
public class AnimatorInflaterCompat {
    ...
    private static PropertyValuesHolder a(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        if (i == 4) {
            if ((obj2 == null || !a(i4)) && (obj3 == null || !a(i5))) {
                i = 0;
            } else {
                i = 3;
            }
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        ...
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "valueFrom") && TypedArrayUtils.hasAttribute(xmlPullParser, "valueTo")) {
            ...
            if (a(typedArray, namedInt3, 5, 6, "") != null) {
                valueAnimator.setValues(new PropertyValuesHolder[]{a(typedArray, namedInt3, 5, 6, "")});
            }
        }
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, a.STYLEABLE_ANIMATOR_SET);
                        ...
                        PropertyValuesHolder[] a = a(context, resources, theme, xmlPullParser, Xml.asAttributeSet(xmlPullParser));
            ...
            if (eventType != 3 && eventType != 1) {
                if (eventType != 2) {
                    ...
                    if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                        Object a;
                        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, a.STYLEABLE_PROPERTY_VALUES_HOLDER);
                        ...
                        if (a2 == null) {
                            a = a(obtainAttributes, namedInt, 0, 1, namedString);
                        } else {
    ...
    private static int a(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        int i = 0;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, a.STYLEABLE_KEYFRAME);
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, "value", 0);
        if ((peekNamedValue != null ? 1 : 0) != 0 && a(peekNamedValue.type)) {
            i = 3;
        }
        obtainAttributes.recycle();
        return i;
        ...
        while (true) {
            ...
            if (next != 3 && next != 1) {
                ...
                if (xmlPullParser.getName().equals("keyframe")) {
                    ...
                    a = a(context, resources, theme, Xml.asAttributeSet(xmlPullParser), i3, xmlPullParser);
                    if (a != null) {
                        if (arrayList == null) {
                            arrayList2 = new ArrayList();
                        } else {
                    ...
                    for (i4 = 0; i4 < i2; i4++) {
                        ...
                        if (keyframe.getFraction() >= 0.0f) {
                            if (i4 == 0) {
                                ...
                                a(keyframeArr, keyframeArr[size + 1].getFraction() - keyframeArr[i4 - 1].getFraction(), i4, size);
                            }
                        }
                    }
    ...
    private static ValueAnimator a(Context context, Resources resources, Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) throws NotFoundException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, a.STYLEABLE_ANIMATOR);
        TypedArray obtainAttributes2 = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, a.STYLEABLE_PROPERTY_ANIMATOR);
