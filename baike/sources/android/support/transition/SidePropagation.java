...
public class SidePropagation extends VisibilityPropagation {
    ...
    public long getStartDelay(ViewGroup viewGroup, Transition transition, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        float a = ((float) a(viewGroup, viewX, viewY, centerX, centerY, round, round2, width, height)) / ((float) a(viewGroup));
        long duration = transition.getDuration();
        if (duration < 0) {
            duration = 300;
        }
        return (long) Math.round((((float) (duration * ((long) i))) / this.a) * a);
    }
    ...
    private int a(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        } else if (this.b == GravityCompat.END) {
            if (ViewCompat.getLayoutDirection(view) != 1) {
                obj = null;
            }
            if (obj == null) {
