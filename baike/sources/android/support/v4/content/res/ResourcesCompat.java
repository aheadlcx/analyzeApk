...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackSuccessAsync(Typeface typeface, @Nullable Handler handler) {
            ...
            handler.post(new a(this, typeface));
        }
    ...
    private static Typeface a(@NonNull Context context, Resources resources, TypedValue typedValue, int i, int i2, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean z) {
