...
public abstract class AppCompatDelegate {
    ...
    private static AppCompatDelegate a(Context context, Window window, AppCompatCallback appCompatCallback) {
        if (VERSION.SDK_INT >= 24) {
            return new n(context, window, appCompatCallback);
        }
        if (VERSION.SDK_INT >= 23) {
            return new r(context, window, appCompatCallback);
        }
        if (VERSION.SDK_INT >= 14) {
            return new p(context, window, appCompatCallback);
        }
        if (VERSION.SDK_INT >= 11) {
            return new o(context, window, appCompatCallback);
        }
