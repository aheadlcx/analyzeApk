...
public abstract class d {
    ...
    public String a(String str, JSONObject jSONObject) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(a5.a)) {
                ...
                f = l.f(context);
                a4 = k.a(context);
                a5.a = "Msp/15.2.7" + " (" + b + h.b + c2 + h.b + f + h.b + a4.substring(0, a4.indexOf("://")) + h.b + l.g(context) + h.b + Float.toString(new TextView(context).getTextSize());
            }
            f = com.alipay.sdk.util.a.b(context).p;
            a4 = "-1;-1";
            String str3 = "1";
            String a7 = a6.a();
            String b2 = a6.b();
            ...
            String replace = Build.MANUFACTURER.replace(h.b, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
            String replace2 = Build.MODEL.replace(h.b, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
            boolean b3 = b.b();
            String str4 = a6.a;
            ...
            stringBuilder.append(a5.a).append(h.b).append(f).append(h.b).append(a4).append(h.b).append(str3).append(h.b).append(a7).append(h.b).append(b2).append(h.b).append(a5.c).append(h.b).append(replace).append(h.b).append(replace2).append(h.b).append(b3).append(h.b).append(str4).append(";-1;-1;").append(a5.b).append(h.b).append(charSequence).append(h.b).append(charSequence2).append(h.b).append(ssid).append(h.b).append(bssid);
            if (a2 != null) {
                HashMap hashMap = new HashMap();
    ...
    private static boolean a(String str) {
        ...
        try {
            ...
            Object optString = jSONObject.getJSONObject("params").optString(m, null);
