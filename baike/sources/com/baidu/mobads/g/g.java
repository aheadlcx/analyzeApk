...
public class g {
    ...
    private static void c(Context context) {
        if (TextUtils.isEmpty(e)) {
            e = context.getDir("baidu_ad_sdk", 0).getAbsolutePath() + MqttTopic.TOPIC_LEVEL_SEPARATOR;
        }
    }
    ...
    protected void a(String str) {
        if (b != null) {
            Editor edit = j().edit();
            edit.putFloat("__badApkVersion__8.7004", (float) b.a);
    ...
    private static synchronized void d(Context context) {
        synchronized (g.class) {
            try {
                String c = c();
                if (Double.valueOf("8.7004").doubleValue() > a(context, c)) {
        ...
        if (k.a((File) bVar)) {
            try {
                ...
                synchronized (this) {
                    ...
                    b(bVar);
                    double d = (double) j().getFloat("__badApkVersion__8.7004", -1.0f);
    ...
    public static double b(Context context) {
        try {
            c(context);
            double a = a(context, e());
            d(context);
            return Math.max(a, a(context, c()));
        } catch (Exception e) {
            return 0.0d;
        }
    }
