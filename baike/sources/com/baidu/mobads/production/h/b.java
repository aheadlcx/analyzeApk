...
public class b extends a implements IXLinearAdSlot, IOAdEventDispatcher {
    ...
    public void e() {
        this.r.i("XPrerollAdSlot", "afterAdContainerInit()");
    ...
    public void request() {
        int parseInt;
        int parseInt2;
        this.v = new a(getApplicationContext(), getActivity(), this.o, this);
        this.v.d(getId());
    ...
    protected void c(IXAdContainer iXAdContainer, HashMap<String, Object> hashMap) {
        if (iXAdContainer.getAdContainerContext().getAdInstanceInfo().getCreativeType() == CreativeType.STATIC_IMAGE || iXAdContainer.getAdContainerContext().getAdInstanceInfo().getCreativeType() == CreativeType.GIF) {
            ...
            com.baidu.mobads.vo.b bVar = (com.baidu.mobads.vo.b) this.v.d();
            ...
            try {
                jSONObject.put("supportTipView", this.w);
    ...
    public void stop() {
        this.r.i("XPrerollAdSlot", "stop()" + getSlotState().getValue());
        super.stop();
    }

    public void pause() {
        this.r.i("XPrerollAdSlot", "pause()" + getSlotState().getValue());
    ...
    public void resume() {
        this.r.i("XPrerollAdSlot", "resume()" + getSlotState().getValue());
