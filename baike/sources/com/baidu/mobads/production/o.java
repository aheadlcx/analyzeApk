...
public class o extends c implements IXAdContainerContext {
    ...
    public class a extends b {
        ...
        public a(o oVar, String str, String str2, HashMap<String, Object> hashMap) {
            this.a = oVar;
            super(str);
            this.b = str2;
            this.c = hashMap;
    ...
    public o(Context context, Activity activity, IXAdProdInfo iXAdProdInfo, RelativeLayout relativeLayout, IXAdContainerEventListener iXAdContainerEventListener, IXAdResponseInfo iXAdResponseInfo, View view) {
        this.b = context;
        this.d = activity;
        this.i = iXAdProdInfo;
