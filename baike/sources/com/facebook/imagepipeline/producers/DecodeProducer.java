            ...
            if (!isFinished() && EncodedImage.isValid(encodedImage)) {
                ...
                try {
                    ...
                    try {
                        ...
                        this.mProducerListener.onProducerFinishWithSuccess(this.mProducerContext.getId(), DecodeProducer.PRODUCER_NAME, getExtraMap(closeableImage, queuedTime, qualityInfo, isLast, name, str2, str, valueOf));
                        ...
                        Throwable th = e2;
                        this.mProducerListener.onProducerFinishWithFailure(this.mProducerContext.getId(), DecodeProducer.PRODUCER_NAME, th, getExtraMap(closeableImage, queuedTime, qualityInfo, isLast, name, str2, str, valueOf));
                        handleError(th);
