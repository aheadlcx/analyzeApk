...
public class DiskCacheWriteProducer implements Producer<EncodedImage> {
    ...
    private void maybeStartInputProducer(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        Consumer diskCacheWriteConsumer;
        if (producerContext.getImageRequest().isDiskCacheEnabled()) {
            diskCacheWriteConsumer = new DiskCacheWriteConsumer(consumer, producerContext, this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCacheKeyFactory);
        } else {
