...
public final class TypeAdapters {
    ...
    final class AnonymousClass33 implements TypeAdapterFactory {
        ...
        public String toString() {
            return "Factory[type=" + this.val$boxed.getName() + MqttTopic.SINGLE_LEVEL_WILDCARD + this.val$unboxed.getName() + ",adapter=" + this.val$typeAdapter + "]";
        }
    }
    ...
    final class AnonymousClass34 implements TypeAdapterFactory {
        ...
        public String toString() {
            return "Factory[type=" + this.val$base.getName() + MqttTopic.SINGLE_LEVEL_WILDCARD + this.val$sub.getName() + ",adapter=" + this.val$typeAdapter + "]";
        }
    }
