...
public class QzoneShare extends BaseApi {
        ...
        if (i.b() || !i.f(activity, "4.5.0")) {
            ...
            if (this.d) {
                ...
                if (!i.e(string2) && string2.length() > 600) {
                    bundle.putString("summary", i.a(string2, 600, null, null));
                }
            }
            ...
            if (!i.f(activity, "4.6.0")) {
                ...
                a.a((Context) activity, stringArrayList, new f(this, iUiListener, bundle, activity));
    ...
    private void b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        StringBuffer stringBuffer2 = new StringBuffer("mqqapi://share/to_qzone?src_type=app&version=1&file_type=news");
        ArrayList stringArrayList = bundle.getStringArrayList("imageUrl");
        ...
        try {
            ...
            if (bundle2 != null) {
                ...
                for (String jSONObject3 : keySet) {
                    jSONObject2.put(jSONObject3, bundle2.get(jSONObject3));
                }
                if (keySet.size() > 0) {
                    ...
                    if (stringArrayList != null) {
                        ...
                        size = stringArrayList.size() <= 9 ? 9 : stringArrayList.size();
                        for (i = 0; i < size; i++) {
                    ...
                    if (!TextUtils.isEmpty(string)) {
                        stringBuffer2.append("&title=" + Base64.encodeToString(i.i(string), 2));
                    }
                    if (!TextUtils.isEmpty(string2)) {
                        stringBuffer2.append("&description=" + Base64.encodeToString(i.i(string2), 2));
                    }
                    if (!TextUtils.isEmpty(appId)) {
                        stringBuffer2.append("&share_id=" + appId);
                    }
                    if (!TextUtils.isEmpty(string3)) {
                        stringBuffer2.append("&url=" + Base64.encodeToString(i.i(string3), 2));
                    }
                    if (!TextUtils.isEmpty(string5)) {
                        stringBuffer2.append("&app_name=" + Base64.encodeToString(i.i(string5), 2));
                    }
                    if (!i.e(openId)) {
                        stringBuffer2.append("&open_id=" + Base64.encodeToString(i.i(openId), 2));
                    }
                    if (!i.e(string4)) {
                        stringBuffer2.append("&audioUrl=" + Base64.encodeToString(i.i(string4), 2));
                    }
                    stringBuffer2.append("&req_type=" + Base64.encodeToString(i.i(String.valueOf(i2)), 2));
                    if (!i.e(string6)) {
                        stringBuffer2.append("&share_qq_ext_str=" + Base64.encodeToString(i.i(string6), 2));
                    }
                    if (!TextUtils.isEmpty(r3)) {
                        stringBuffer2.append("&share_qzone_ext_str=" + Base64.encodeToString(i.i(r3), 2));
                    }
                    stringBuffer2.append("&cflag=" + Base64.encodeToString(i.i(String.valueOf(i3)), 2));
                    f.a("openSDK_LOG.QzoneShare", "doshareToQzone, url: " + stringBuffer2.toString());
