...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            String b = b(bundle.getString(KEY_IDENTIFIER));
            if (b == null || b.length() <= 0) {
                return wXMediaMessage;
            }
            try {
                wXMediaMessage.mediaObject = (IMediaObject) Class.forName(b).newInstance();
        ...
        public static Bundle toBundle(WXMediaMessage wXMediaMessage) {
            ...
            if (wXMediaMessage.mediaObject != null) {
                bundle.putString(KEY_IDENTIFIER, a(wXMediaMessage.mediaObject.getClass().getName()));
