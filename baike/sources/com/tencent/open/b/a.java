...
public class a {
    ...
    public static int d(Context context) {
        try {
            ...
            if (activeNetworkInfo.getTypeName().toUpperCase().equals(NetworkDiagnosisActivity.NETWORKTYPE_WIFI)) {
                return 2;
            }
            ...
            if (toLowerCase.startsWith(HttpUtils.WAP)) {
                return 64;
            }
