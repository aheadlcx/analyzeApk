...
public class n {
        ...
        if (StatConfig.getMaxStoreEventCount() > 0) {
            try {
                ...
                if (this.b > StatConfig.getMaxStoreEventCount()) {
                    ...
                    this.b -= this.d.getWritableDatabase().delete(b.Y, "event_id in (select event_id from events where timestamp in (select min(timestamp) from events) limit 1)", null);
                }
                ...
                if (this.d.getWritableDatabase().insert(b.Y, null, contentValues) == -1) {
    ...
    private synchronized void b(List<x> list) {
        try {
            ...
            try {
                this.d.getWritableDatabase().beginTransaction();
                for (x xVar : list) {
                    this.b -= this.d.getWritableDatabase().delete(b.Y, "event_id = ?", new String[]{Long.toString(xVar.a)});
                }
                this.d.getWritableDatabase().setTransactionSuccessful();
                this.b = (int) DatabaseUtils.queryNumEntries(this.d.getReadableDatabase(), b.Y);
                this.d.getWritableDatabase().endTransaction();
            } catch (Throwable th) {
                try {
                    this.d.getWritableDatabase().endTransaction();
            ...
            try {
                ...
                for (x xVar : list) {
                    if (xVar.d + 1 > StatConfig.getMaxSendRetryCount()) {
                        ...
                        int update = this.d.getWritableDatabase().update(b.Y, contentValues, "event_id=?", new String[]{Long.toString(xVar.a)});
                        if (update <= 0) {
    ...
    private void c(List<x> list, int i) {
        ...
        Cursor cursor2 = null;
        try {
            Cursor query = this.d.getReadableDatabase().query(b.Y, null, "status=?", new String[]{Integer.toString(1)}, null, null, "event_id", Integer.toString(i));
    ...
    private void e() {
        try {
            ...
            this.d.getWritableDatabase().update(b.Y, contentValues, "status=?", new String[]{Long.toString(2)});
            this.b = (int) DatabaseUtils.queryNumEntries(this.d.getReadableDatabase(), b.Y);
            ...
            try {
                ...
                try {
                    ...
                    if (query.moveToNext()) {
                        ...
                        contentValues.put(IMChatBaseActivity.USER_TYPE, Integer.valueOf(i3));
                    ...
                    if (obj == null) {
                        ...
                        contentValues2.put(IMChatBaseActivity.USER_TYPE, Integer.valueOf(0));
