...
public class d {
    ...
    public static InputStream a(Context context, URL url, boolean z, String str, String str2, Map<String, String> map, b bVar) {
        if (context == null) {
            throw new IllegalArgumentException(com.umeng.analytics.pro.b.M);
        } else if (url == null) {
    ...
    public static String a(URL url) {
        ...
        stringBuilder.append(url.getProtocol()).append("://").append(HttpUtils.PROXY_IP).append(url.getPath());
    ...
    public static boolean b(Context context) {
        ...
        try {
            ...
            try {
                ...
                return (TextUtils.isEmpty(extraInfo) || extraInfo.length() < 3 || extraInfo.contains("ctwap")) ? false : extraInfo.regionMatches(true, extraInfo.length() - 3, HttpUtils.WAP, 0, 3);
            } catch (Exception e) {
                return false;
            }
        } catch (Exception e2) {
