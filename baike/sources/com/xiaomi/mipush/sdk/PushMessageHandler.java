...
public class PushMessageHandler extends IntentService {
    ...
    public static void a(Context context, MiPushMessage miPushMessage) {
        synchronized (a) {
            for (MiPushClientCallback miPushClientCallback : a) {
                if (a(miPushMessage.getCategory(), miPushClientCallback.a())) {
    ...
    protected static void a(Context context, String str, long j, String str2, String str3) {
        synchronized (a) {
            for (MiPushClientCallback miPushClientCallback : a) {
                if (a(str, miPushClientCallback.a())) {
        ...
        try {
            if ("com.xiaomi.mipush.sdk.WAKEUP".equals(intent.getAction())) {
                if (a.a((Context) this).i()) {
                    ...
                    aw.a().a("system_running_log", "wake_up_app", 1, jSONObject.toString());
                }
