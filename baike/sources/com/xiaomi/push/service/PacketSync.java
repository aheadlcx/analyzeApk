        ...
        switch (bVar.c()) {
            case 0:
                if ("PING".equals(a)) {
                    ...
                    if ("CONF".equals(bVar.b())) {
                        ...
                        return;
                    } else if (TextUtils.equals(BaseUserInfo.GENDER_UNKONW, bVar.b())) {
                        k b2 = k.b(bVar.k());
            ...
            default:
                ...
                if ("SECMSG".equals(bVar.a())) {
                    ...
                    r5 = b5.f();
                    if (com.alipay.sdk.app.statistic.c.d.equals(r5)) {
