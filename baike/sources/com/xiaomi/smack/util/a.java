...
public class a {
    ...
    public static b a(XmlPullParser xmlPullParser, com.xiaomi.smack.a aVar) {
        ...
        while (obj == null) {
            ...
            if (next == 2) {
                ...
                if (name.equals(com.umeng.analytics.pro.b.J)) {
    ...
    public static d a(XmlPullParser xmlPullParser) {
        ...
        while (!z2) {
            ...
            if (next2 == 2) {
                ...
                } else if (attributeValue.equals(com.umeng.analytics.pro.b.J)) {
    ...
    public static f b(XmlPullParser xmlPullParser) {
        ...
        while (i == 0) {
            ...
            if (next == 2) {
                ...
                } else if (name.equals(com.umeng.analytics.pro.b.J)) {
    ...
    public static g c(XmlPullParser xmlPullParser) {
        ...
        while (obj == null) {
            ...
            } else if (next == 3 && xmlPullParser.getName().equals(com.umeng.analytics.pro.b.J)) {
                obj = 1;
            }
        }
        return gVar;
    ...
    public static h d(XmlPullParser xmlPullParser) {
        ...
        while (obj == null) {
            ...
            if (next == 2) {
                ...
                if (xmlPullParser.getName().equals(com.umeng.analytics.pro.b.J)) {
                    obj = 1;
                }
            } else if (next == 4) {
