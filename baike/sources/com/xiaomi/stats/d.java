...
final class d {
    ...
    static a a(Exception exception) {
        ...
        message = a.getClass().getSimpleName() + Config.TRACE_TODAY_VISIT_SPLIT + message;
        int a2 = c.a(a);
        if (a2 != 0) {
            aVar.a = com.xiaomi.push.thrift.a.a(a2 + com.xiaomi.push.thrift.a.GSLB_REQUEST_SUCCESS.a());
        }
        if (aVar.a == null) {
    ...
    static a c(Exception exception) {
        ...
        int a2 = c.a(a);
        String str = a.getClass().getSimpleName() + Config.TRACE_TODAY_VISIT_SPLIT + message;
        switch (a2) {
            case 105:
