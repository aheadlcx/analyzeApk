...
public class b implements Serializable, Cloneable, org.apache.thrift.a<b, a> {
    ...
    static {
        ...
        enumMap.put(a.ID, new org.apache.thrift.meta_data.b("id", (byte) 1, new c((byte) 8)));
        enumMap.put(a.SIGNAL_STRENGTH, new org.apache.thrift.meta_data.b("signalStrength", (byte) 1, new c((byte) 8)));
