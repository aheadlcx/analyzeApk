...
public final class DistinguishedNameParser {
    ...
    private String a() {
        while (this.c < this.b && this.g[this.c] == TokenParser.SP) {
            this.c++;
        }
        if (this.c == this.b) {
            return null;
        ...
        this.d = this.c;
        this.c++;
        while (this.c < this.b && this.g[this.c] != '=' && this.g[this.c] != TokenParser.SP) {
            this.c++;
        }
        if (this.c >= this.b) {
        ...
        this.e = this.c;
        if (this.g[this.c] == TokenParser.SP) {
            while (this.c < this.b && this.g[this.c] != '=' && this.g[this.c] == TokenParser.SP) {
                this.c++;
            }
    ...
    private String b() {
        ...
        while (this.c != this.b) {
            ...
            if (this.g[this.c] == TokenParser.ESCAPE) {
                this.g[this.e] = e();
            } else {
    ...
    private char f() {
        ...
        for (a = 0; a < i; a++) {
            this.c++;
            if (this.c == this.b || this.g[this.c] != TokenParser.ESCAPE) {
                return '?';
            }
            this.c++;
            int a2 = a(this.c);
