...
public final class ComparisonsKt__ComparisonsKt$compareBy$1 implements Comparator<T> {
    ...
    public int compare(T t, T t2) {
        Function1[] function1Arr = this.a;
        return a.compareValuesBy(t, t2, (Function1[]) Arrays.copyOf(function1Arr, function1Arr.length));
    }
}
