...
class a {
    public static final <T> int compareValuesBy(T t, T t2, @NotNull Function1<? super T, ? extends Comparable<?>>... function1Arr) {
        ...
        if ((((Object[]) function1Arr).length > 0 ? 1 : 0) == 0) {
    ...
    public static final <T> Comparator<T> reversed(@NotNull Comparator<T> comparator) {
        ...
        if (comparator instanceof e) {
            return ((e) comparator).getComparator();
        }
        if (Intrinsics.areEqual(comparator, c.INSTANCE)) {
            d dVar = d.INSTANCE;
            if (dVar != null) {
                return dVar;
            }
            throw new TypeCastException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        } else if (!Intrinsics.areEqual(comparator, d.INSTANCE)) {
