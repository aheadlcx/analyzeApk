...
public abstract class Internal {
    ...
    public abstract void addLenient(Headers$Builder headers$Builder, String str);

    public abstract void addLenient(Headers$Builder headers$Builder, String str, String str2);

    public abstract void apply(ConnectionSpec connectionSpec, SSLSocket sSLSocket, boolean z);

    public abstract int code(Builder builder);
