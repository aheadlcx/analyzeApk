...
public final class StatusLine {
    ...
    public static StatusLine parse(String str) throws IOException {
        ...
        if (str.startsWith("HTTP/1.")) {
            if (str.length() < 9 || str.charAt(8) != TokenParser.SP) {
        ...
        try {
            ...
            if (str.length() <= i + 3) {
                str2 = str3;
            } else if (str.charAt(i + 3) != TokenParser.SP) {
                throw new ProtocolException("Unexpected status line: " + str);
            } else {
    ...
    public String toString() {
        ...
        stringBuilder.append(TokenParser.SP).append(this.code);
        if (this.message != null) {
            stringBuilder.append(TokenParser.SP).append(this.message);
        }
