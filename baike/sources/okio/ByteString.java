...
public class ByteString implements Serializable, Comparable<ByteString> {
    ...
    public ByteString substring(int i, int i2) {
        if (i < 0) {
            ...
            if (i3 < 0) {
                ...
                System.arraycopy(this.b, i, obj, 0, i3);
                this(obj);
                return this;
            }
        }
    ...
    public boolean rangeEquals(int i, byte[] bArr, int i2, int i3) {
        return i >= 0 && i <= this.b.length - i3 && i2 >= 0 && i2 <= bArr.length - i3 && r.arrayRangeEquals(this.b, i, bArr, i2, i3);
    }
    ...
    public int indexOf(byte[] bArr, int i) {
        ...
        for (int max = Math.max(i, 0); max <= length; max++) {
            if (r.arrayRangeEquals(this.b, max, bArr, 0, bArr.length)) {
                return max;
            }
        }
        return -1;
    ...
    public int lastIndexOf(byte[] bArr, int i) {
        for (int min = Math.min(i, this.b.length - bArr.length); min >= 0; min--) {
            if (r.arrayRangeEquals(this.b, min, bArr, 0, bArr.length)) {
                return min;
            }
        }
        return -1;
    ...
    public boolean equals(Object obj) {
        ...
        boolean z;
        if ((obj instanceof ByteString) && ((ByteString) obj).size() == this.b.length && ((ByteString) obj).rangeEquals(0, this.b, 0, this.b.length)) {
            z = true;
        } else {
            z = false;
        }
