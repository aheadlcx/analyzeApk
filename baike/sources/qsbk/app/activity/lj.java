...
class lj extends AsyncTask<Void, Void, Pair<Integer, String>> {
    final /* synthetic */ UploadListener a;
    final /* synthetic */ Uri b;
    final /* synthetic */ FinishGroupActivity c;

    lj(FinishGroupActivity finishGroupActivity, UploadListener uploadListener, Uri uri) {
    ...
    protected Pair<Integer, String> a(Void... voidArr) {
        try {
            ...
            String str = Constants.URL_GET_TOKEN_FOR_GROUP;
