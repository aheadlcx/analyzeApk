...
class au extends NormalCell {
    final /* synthetic */ CircleHotCommentAdapter a;

    au(CircleHotCommentAdapter circleHotCommentAdapter, ShareUtils$OnCircleShareStartListener shareUtils$OnCircleShareStartListener, boolean z) {
    ...
    public void onUpdate() {
        ...
        this.hotComment.setOnClickListener(new av(this));
