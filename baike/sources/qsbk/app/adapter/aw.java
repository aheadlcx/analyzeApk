...
class aw extends ForwardCell {
    final /* synthetic */ CircleHotCommentAdapter a;

    aw(CircleHotCommentAdapter circleHotCommentAdapter, ShareUtils$OnCircleShareStartListener shareUtils$OnCircleShareStartListener, boolean z) {
    ...
    public void onUpdate() {
        ...
        this.hotComment.setOnClickListener(new ax(this));
