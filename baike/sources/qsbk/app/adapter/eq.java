...
class eq implements OnClickListener {
    ...
    eq(GdtVideoImmersionCell gdtVideoImmersionCell) {
    ...
    public void onClick(View view) {
        if (this.a.v == null || !this.a.v.isVideoAD() || !this.a.v.isVideoLoaded() || this.a.v.isPlaying()) {
            ...
            if (FeedsAdUtils.needShowConfirm(network)) {
                new Builder(context).setTitle("温馨提示").setCancelable(true).setMessage("当前为" + network + "网络，开始下载应用？").setNegativeButton("取消", new es(this)).setPositiveButton("确认", new er(this, context)).create().show();
                return;
            }
        ...
        this.a.p.l.smoothScrollToPositionFromTop(this.a.q + this.a.p.l.getHeaderViewsCount(), this.a.p.b, ErrorCode$OtherError.CONTENT_FORCE_EXPOSURE);
    }
}
