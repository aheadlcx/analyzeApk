...
public class WebActivity extends BaseActivity implements WebInterface {
    ...
    protected void initView() {
        setOnUpClickListener(new f(this));
        this.c = (ImageButton) findViewById(R.id.iv_action);
        ...
        this.a.setWebChromeClient(new g(this, this.a.getExposeApi()));
        this.a.addJavascriptInterface(new WebActivity$GetWebShareInfo(this), "GetWebShareInfo");
    }
    ...
    protected void initData() {
        ...
        if (TextUtils.isEmpty(this.g)) {
            ...
            this.c.setImageResource(R.drawable.core_web_share);
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        if ((i == LiveShareActivity.SHARE_NO_LOGIN || i == ChargePlugin.CHAREG_CODE) && i2 == -1) {
            a(this.a.getUrl());
        }
        if (this.e != null) {
