...
class iy extends VideoInListHelper {
    final /* synthetic */ QiushiTopicFragment a;

    iy(QiushiTopicFragment qiushiTopicFragment, ListView listView) {
        this.a = qiushiTopicFragment;
        super(listView);
    }
