...
*/
        /*
        r5 = this;
        r0 = qsbk.app.model.WelcomeCard.o;
        r1 = r0.obtainMessage();
        ...
        qsbk.app.model.WelcomeCard.a = r0;	 Catch:{ JSONException -> 0x0041, QiushibaikeException -> 0x0052, all -> 0x0065 }
        r0 = qsbk.app.model.WelcomeCard.a;	 Catch:{ JSONException -> 0x0041, QiushibaikeException -> 0x0052, all -> 0x0065 }
    ...
    L_0x006b:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: qsbk.app.model.z.run():void");
    }

    z(String str, HashMap hashMap) {
        this.a = hashMap;
        super(str);
    }
}
