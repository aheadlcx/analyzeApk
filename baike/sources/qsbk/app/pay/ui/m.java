...
class m extends Callback {
    ...
    m(PayActivity payActivity, float f, float f2, String str) {
        this.d = payActivity;
        this.a = f;
        this.b = f2;
        this.c = str;
    ...
    public void onSuccess(BaseResponse baseResponse) {
        ...
        if (simpleDataInt == 0) {
            ...
            this.d.b(simpleDataInt, baseResponse.getSimpleDataStr(UriUtil.LOCAL_RESOURCE_SCHEME), this.b, this.a, this.c);
            return;
        }
        String format = String.format("返回码不为0，而是%s", new Object[]{Integer.valueOf(simpleDataInt)});
        this.d.l.post(new n(this, format));
        this.d.a(Token.WX_TOKEN_PLATFORMID_VALUE, this.c, simpleDataInt, format);
    }
    ...
    public void onFailed(int i, String str) {
        this.d.a(Token.WX_TOKEN_PLATFORMID_VALUE, this.c, i, str);
    }
}
