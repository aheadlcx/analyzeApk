...
public class CircleTopicBannerCell extends BaseCell {
    ImageView a;
    TextView b;
    ImageView c;
    TextView d;
    ...
    public void onUpdate() {
        ...
        FrescoImageloader.displayImage(this.c, circleTopicBanner.picUrl, UIHelper.getDefaultImageTileBackground());
        getCellView().setOnClickListener(new as(this, circleTopicBanner));
    }
}
