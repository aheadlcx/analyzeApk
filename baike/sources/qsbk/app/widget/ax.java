...
class ax implements OnClickListener {
    ...
    ax(CircleTopicThreeImageCell circleTopicThreeImageCell, CircleTopic circleTopic, String[] strArr) {
    ...
    public void onClick(View view) {
        CircleTopicActivity.launch(this.c.getContext(), this.a, -1, true, this.b[0]);
