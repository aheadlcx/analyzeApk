...
class az implements OnClickListener {
    ...
    az(CircleTopicThreeImageCell circleTopicThreeImageCell, CircleTopic circleTopic, String[] strArr) {
    ...
    public void onClick(View view) {
        CircleTopicActivity.launch(this.c.getContext(), this.a, -1, true, this.b[2]);
