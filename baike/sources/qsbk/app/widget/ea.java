...
class ea implements OnClickListener {
    ...
    ea(QiuyouCircleNotificationItemView qiuyouCircleNotificationItemView) {
        this.a = qiuyouCircleNotificationItemView;
    }

    public void onClick(View view) {
        QiuyouCircleLikedListActivity.gotoQiuyouquan(view.getContext(), QiuyouCircleNotificationItemView.a(this.a));
