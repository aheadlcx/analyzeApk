...
class ec implements OnClickListener {
    ...
    ec(QiuyouCircleNotificationItemView qiuyouCircleNotificationItemView) {
        this.a = qiuyouCircleNotificationItemView;
    }

    public void onClick(View view) {
        QiuyouCircleLikedListActivity.gotoQiuyouquan(view.getContext(), QiuyouCircleNotificationItemView.a(this.a), this.a.isAtInfo, this.a.isCommentLike);
