...
public class ShareCell extends BaseUserCell {
    ...
    public ShareCell(ShareUtils$OnCircleShareStartListener shareUtils$OnCircleShareStartListener) {
        super(shareUtils$OnCircleShareStartListener);
    }

    public ShareCell(ShareUtils$OnCircleShareStartListener shareUtils$OnCircleShareStartListener, boolean z) {
        super(shareUtils$OnCircleShareStartListener);
        this.fromCircleTopic = z;
    }

    public ShareCell(ShareUtils$OnCircleShareStartListener shareUtils$OnCircleShareStartListener, boolean z, boolean z2) {
    ...
    public void onUpdate() {
        ...
        int i = circleArticle.isTop ? UIHelper.isNightTheme() ? R.drawable.ic_circle_top_night : R.drawable.ic_circle_top : circleArticle.isRecommend ? UIHelper.isNightTheme() ? R.drawable.ic_circle_recommend_night : R.drawable.ic_circle_recommend : 0;
