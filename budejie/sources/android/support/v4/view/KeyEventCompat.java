...
public final class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int i) {
            ...
            return i2 & R$styleable.Theme_Custom_top_suiji_btn_bg;
        }

        public boolean metaStateHasModifiers(int i, int i2) {
            if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(i) & R$styleable.Theme_Custom_top_suiji_btn_bg, i2, 1, 64, 128), i2, 2, 16, 32) == i2) {
                return true;
            }
            return false;
        }
        ...
        public boolean metaStateHasNoModifiers(int i) {
            return (normalizeMetaState(i) & R$styleable.Theme_Custom_top_suiji_btn_bg) == 0;
        }
