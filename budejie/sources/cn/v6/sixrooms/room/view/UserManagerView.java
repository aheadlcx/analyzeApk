...
public class UserManagerView extends RelativeLayout implements OnGestureListener {
    ...
    L_0x006f:
        ...
        goto L_0x003c;
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.v6.sixrooms.room.view.UserManagerView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private Rect a(View view) {
        ...
        if (view2 == null || (view2 instanceof cn.v6.sixrooms.widgets.phone.UserManagerView) || (view2 instanceof CheckSoftInputRelativeLayout)) {
            return rect;
        }
        Rect a = a(view2);
        rect.left += a.left;
