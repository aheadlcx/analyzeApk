...
public class CarRedHeart1_1Element extends CarRedHeartElement {
    ...
    public CarRedHeart1_1Element(AnimScene animScene) {
        ...
        PointI pointI2 = new PointI(getScalePx(R$styleable.Theme_Custom_share_qzone_theme), getScalePx(710));
        PointI pointI3 = new PointI(getScalePx(R$styleable.Theme_Custom_more_text_color), getScalePx(830));
        ...
        this.l = new AnimFloatEvaluator(2, 25, -50.0f, 5.0f);
        ...
        this.p = new AnimFloatEvaluator(2, 15, 5.0f, -90.0f);
    ...
    public boolean frameControl(int i) {
        ...
        int i2 = (i - this.v) + 1;
        float evaluate = this.mElementScale * this.k.evaluate(i2);
        ...
        if (i2 > 2) {
            ...
            float evaluate5 = this.mElementScale * this.m.evaluate(i2);
            ...
            evaluate5 = this.mElementScale * this.q.evaluate(i2);
        ...
        if (i2 >= 4) {
            ...
            evaluate4 = this.mElementScale * this.o.evaluate(i2);
        ...
        if (i2 == 1) {
            ...
            ((AnimBitmap[]) this.mAnimEntities)[1].setTranslateX(((AnimBitmap[]) this.mAnimEntities)[1].getTranslateX()).setTranslateY(((AnimBitmap[]) this.mAnimEntities)[1].getTranslateY()).setRotate(this.l.evaluate(i2));
            ((AnimBitmap[]) this.mAnimEntities)[3].setTranslateX(((AnimBitmap[]) this.mAnimEntities)[3].getTranslateX()).setTranslateY(((AnimBitmap[]) this.mAnimEntities)[1].getTranslateY()).setRotate(this.p.evaluate(i2));
        }
        return false;
    }
