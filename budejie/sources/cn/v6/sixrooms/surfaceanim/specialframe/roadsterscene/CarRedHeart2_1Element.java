...
public class CarRedHeart2_1Element extends CarRedHeartElement {
    ...
    public CarRedHeart2_1Element(AnimScene animScene) {
        ...
        PointI pointI2 = new PointI(getScalePx(211), getScalePx(1393));
        PointI pointI3 = new PointI(getScalePx(R$styleable.Theme_Custom_comment_operate_dub_icon), getScalePx(1183));
    ...
    public boolean frameControl(int i) {
        ...
        if (i2 > 0) {
            float evaluate3 = this.mElementScale * this.l.evaluate(i2);
            ...
            float evaluate4 = this.mElementScale * this.p.evaluate(i2);
        ...
        if (i2 >= 2) {
            evaluate3 = this.mElementScale * this.n.evaluate(i2);
            ...
            evaluate4 = this.mElementScale * this.r.evaluate(i2);
            ...
            evaluate4 = this.mElementScale * this.v.evaluate(i2);
        ...
        if (i2 >= 3) {
            float evaluate5 = this.mElementScale * this.t.evaluate(i2);
