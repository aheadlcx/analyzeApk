...
public class CarRedHeart3Element extends CarRedHeartElement {
    ...
    public CarRedHeart3Element(AnimScene animScene) {
        ...
        PointI pointI7 = new PointI(getScalePx(R$styleable.Theme_Custom_last_refresh_item_text_theme), getScalePx(577));
        PointI pointI8 = new PointI(getScalePx(R$styleable.Theme_Custom_forward_icon), getScalePx(580));
    ...
    public boolean frameControl(int i) {
        ...
        if (i2 > 0) {
            int i3;
            float evaluate4 = this.h.evaluate(i2);
            if (i2 < 12) {
        ...
        if (i2 >= 2) {
            float evaluate6 = this.j.evaluate(i2);
        ...
        if (i2 >= 4) {
            float evaluate7 = this.l.evaluate(i2);
