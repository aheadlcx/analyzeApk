...
public class PullToRefreshView extends LinearLayout {
    ...
    private void a() {
        ...
        this.j = this.v.inflate(R.layout.refresh_layout_header, this, false);
    ...
    protected void onFinishInflate() {
        ...
        this.k = this.v.inflate(R.layout.refresh_layout_footer, this, false);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case 3:
                ...
                if (this.c == 1) {
                    if (Math.abs(paddingTop) >= this.n) {
                        this.A.startScroll(0, paddingTop, 0, -(this.n + paddingTop), 250);
                        this.a = 13;
                        c();
                        if (this.z != null) {
                        ...
                        this.A.startScroll(0, paddingTop, 0, -paddingTop, 250);
                        this.a = 14;
                        c();
                    }
                } else if (this.c == 0) {
                    if (Math.abs(paddingTop) >= this.o) {
                        this.A.startScroll(0, paddingTop, 0, -(paddingTop - this.o), 250);
                        this.b = 23;
                        d();
                        if (this.y != null) {
            ...
            case 2:
                ...
                if (z && Math.abs(i) > 0) {
                    ...
                    if (top < 0) {
                        ...
                        scrollTo(0, top);
                        top = getScrollY();
                        if (Math.abs(top) <= this.n && this.a == 14) {
                            this.a = 11;
                            c();
                        } else if (Math.abs(top) > this.n && this.a == 11) {
                            this.a = 12;
                            c();
                        } else if (Math.abs(top) <= this.n && this.a == 12) {
                            this.a = 11;
                            this.d = true;
                            c();
                        }
                    ...
                    if (top > 0) {
                        ...
                        scrollTo(0, top);
                        top = getScrollY();
                        if (Math.abs(top) <= this.o && this.b == 24) {
                            this.b = 21;
                            d();
                        } else if (Math.abs(top) > this.o && this.b == 21) {
                            this.b = 22;
                            d();
                        } else if (Math.abs(top) <= this.o && this.b == 22) {
                            this.e = true;
                            this.b = 21;
                            d();
                        }
    ...
    public void isBanPullDownRefresh(boolean z) {
        if (this.F != z) {
            this.F = z;
            if (z) {
                onHeaderRefreshComplete();
