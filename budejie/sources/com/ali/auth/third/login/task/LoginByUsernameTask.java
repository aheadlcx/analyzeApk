            ...
            if (loginByUserName == null) {
                ...
                try {
                    if (loginByUserName.code == ErrorCode.SERVER_OPERATIONTYPEMISSED) {
                        ...
                        r2 = new JSONObject();
                        r2.put(CheckCodeDO.CHECKCODE_USER_INPUT_KEY, loginByUserName.code);
                        ...
                        hashMap.put(CheckCodeDO.CHECKCODE_USER_INPUT_KEY, loginByUserName.code + "");
                        if (!TextUtils.isEmpty(loginByUserName.message)) {
                            hashMap.put(b.EVENT_MESSAGE, loginByUserName.message);
                        }
