...
public class MtopRemoteLoginImpl implements IRemoteLogin {
    public void login(final onLoginListener onloginlistener, boolean z) {
        ...
        try {
            Class cls = Class.forName("com.ali.auth.third.login.LoginServiceImpl");
            ReflectionUtils.invoke("com.ali.auth.third.login.LoginServiceImpl", c.d, new String[]{"com.ali.auth.third.core.callback.LoginCallback"}, cls.newInstance(), new Object[]{anonymousClass1});
