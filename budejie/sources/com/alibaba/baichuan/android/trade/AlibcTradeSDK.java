...
public class AlibcTradeSDK {
    ...
    private static void a(AlibcTradeInitCallback alibcTradeInitCallback, InitResult initResult) {
        initState.setState(3);
        AlibcContext.executorService.b(new e(alibcTradeInitCallback, initResult));
    }
    ...
    private static void b() {
        ...
        CharSequence appKey = AlibcContext.getAppKey();
    ...
    private static synchronized void b(AlibcTradeInitCallback alibcTradeInitCallback) {
        synchronized (AlibcTradeSDK.class) {
