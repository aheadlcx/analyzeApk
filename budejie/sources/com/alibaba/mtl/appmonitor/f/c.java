        ...
        for (Entry entry : map.entrySet()) {
            ...
            if (list.size() != 0) {
                ...
                if (eventId != null) {
                    ...
                    hVar.k.put(a.a(), new JSONObject(hashMap).toString());
                    String stringBuilder3 = stringBuilder.toString();
                    String stringBuilder4 = stringBuilder2.toString();
                    hVar.k.put(LogField.ARG1.toString(), stringBuilder3);
                    hVar.k.put(LogField.ARG2.toString(), stringBuilder4);
