...
public final class b implements HttpClient {
    ...
    private static String[] b = new String[]{"text/", "application/xml", FastJsonJsonView.DEFAULT_CONTENT_TYPE};
    ...
    public static b a(String str) {
        ...
        Security.setProperty("networkaddress.cache.ttl", RoomActivity.VIDEOTYPE_UNKNOWN);
