...
public class a extends b {
    ...
    public void a() {
        ...
        try {
            ...
            if (a != null) {
                ...
                uRIUitls.pintHttpInNewThread(this.c.getClickThroughUrl());
                com.baidu.mobads.production.a.f().getXMonitorActivation(this.a, this.e).startMonitor();
                return;
            } else {
    ...
    private void b(com.baidu.mobads.command.a aVar) {
        if (com.baidu.mobads.production.a.f() != null) {
            IXAppInfo a = a(aVar);
            if (a != null) {
                com.baidu.mobads.production.a.f().getXMonitorActivation(this.a, this.e).addAppInfoForMonitor(a);
            } else {
    ...
    public static IXAppInfo a(com.baidu.mobads.command.a aVar) {
        ...
        IXAdContainerFactory f = com.baidu.mobads.production.a.f();
        if (f == null) {
            return null;
        }
