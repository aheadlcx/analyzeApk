...
public class b implements Observer {
    ...
    public void update(Observable observable, Object obj) {
        ...
        if (this.c.g == DownloadStatus.COMPLETED) {
            ...
            if (a != null) {
                com.baidu.mobads.production.a.f().getXMonitorActivation(this.d, l.a()).addAppInfoForMonitor(a);
            }
        } else if (this.c.g == DownloadStatus.ERROR) {
            this.c.k = iOAdDownloader.getTargetURL();
            XAdSDKFoundationFacade.getInstance().getAdLogger().e(new Object[]{"OAdApkDownloaderObserver", "download failed-->>" + iOAdDownloader.getOutputPath()});
