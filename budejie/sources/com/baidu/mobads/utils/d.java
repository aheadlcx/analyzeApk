...
public class d implements IXAdCommonUtils {
    ...
    public String getMD5(String str) {
        ...
        try {
            ...
            XAdSDKFoundationFacade.getInstance().getAdLogger().e(new Object[]{"AdUtil.getMD5", "", e});
            return null;
        }
    }
    ...
    public void makeCall(Context context, String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                Intent intent = new Intent("android.intent.action.CALL", Uri.parse((WebView.SCHEME_TEL + str).toString()));
    ...
    public String vdUrl(String str, int i) {
        ...
        for (String str22 : treeMap.keySet()) {
            ...
            if (!(str22 == null || str3 == null)) {
                ...
                stringBuilder.append(str22 + LoginConstants.EQUAL + str3 + "&");
    ...
    public void browserOutside(Context context, String str) {
        if (str.startsWith("wtai://wp/mc;")) {
            str = WebView.SCHEME_TEL + str.substring("wtai://wp/mc;".length());
        }
        Intent intent;
        try {
            ...
            XAdSDKFoundationFacade.getInstance().getAdLogger().d(new Object[]{"XAdCommonUtils.browserOutside 1", str, e});
            try {
                intent = new Intent("android.intent.action.VIEW", Uri.parse(str));
                intent.addFlags(268435456);
                context.startActivity(intent);
            } catch (Exception e2) {
                XAdSDKFoundationFacade.getInstance().getAdLogger().d(new Object[]{"XAdCommonUtils.browserOutside 2", str, e2});
            }
        }
    }

    public String b() {
        return "android_8.7018_4.0.0";
    }
