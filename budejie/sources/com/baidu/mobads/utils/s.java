...
public class s implements IXAdURIUitls {
    ...
    public String getRequestAdUrl(String str, HashMap<String, String> hashMap) {
        ...
        if (hashMap != null) {
            ...
            for (String str3 : hashMap.keySet()) {
                ...
                if (i2 == 1) {
                    stringBuilder.append(str3).append(LoginConstants.EQUAL).append(str2);
                } else {
                    stringBuilder.append("&").append(str3).append(LoginConstants.EQUAL).append(str2);
                }
                i = i2;
            }
        }
    ...
    public String addParameter(String str, String str2, String str3) {
        ...
        if (XAdSDKFoundationFacade.getInstance().getCommonUtils().isStringAvailable(queryString)) {
            queryString = queryString + "&" + str2 + LoginConstants.EQUAL + str3;
        } else {
            queryString = str2 + LoginConstants.EQUAL + str3;
        }
