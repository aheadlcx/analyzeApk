...
class e$4 extends a<String> {
    final /* synthetic */ RecommendSubscription a;
    final /* synthetic */ e b;

    e$4(e eVar, RecommendSubscription recommendSubscription) {
        this.b = eVar;
            ...
            if (s != null) {
                ...
                if (!TextUtils.isEmpty(code) && "0".equals(code)) {
                    ...
                    new Thread(new Runnable(this) {
                        ...
                        public void run() {
                            e.b(this.a.b).a("recommend_Label", this.a.a.getTheme_id(), this.a.a.getSub_number(), "0");
                            e.b(this.a.b).e("subscribe_Label", this.a.a.getTheme_id());
                        }
                    }).start();
                }
            } else {
