...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    public void setmEnablePullToRefresh(boolean z) {
        this.d = z;
    }
        ...
        if (this.t) {
            switch (motionEvent.getAction()) {
                ...
                case 2:
                    ...
                    if (this.d && this.a != 2 && this.k && this.a != 4) {
                        if (this.a == 0) {
                            setSelection(0);
    ...
    private void c() {
        switch (this.a) {
            case 0:
                ...
                this.i.setBackgroundResource(R.drawable.list_view_release);
                return;
            case 1:
                this.g.setVisibility(0);
                this.h.setVisibility(0);
                ...
                if (this.p) {
                    ...
                    this.i.setBackgroundResource(R.drawable.list_view_pull);
                    return;
                }
                this.g.setText(R.string.pull_to_refresh_label);
                this.i.setBackgroundResource(R.drawable.list_view_pull);
            ...
            case 2:
                ...
                this.i.setBackgroundResource(R.drawable.recyclerview_header_refreshing_anim);
