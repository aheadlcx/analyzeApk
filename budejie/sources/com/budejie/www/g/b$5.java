...
class b$5 implements IUiListener {
    final /* synthetic */ Handler a;
    final /* synthetic */ HuodongBean b;
    final /* synthetic */ b c;

    b$5(b bVar, Handler handler, HuodongBean huodongBean) {
        this.c = bVar;
        this.a = handler;
        this.b = huodongBean;
    }
    ...
    public void onComplete(Object obj) {
        ...
        if (jSONObject != null && jSONObject.has(KEYS.RET)) {
            ...
            if (i == 0) {
                ...
                b.a(b.a(this.c), this.b.getHuodongId(), "qqFriends", "huodong");
                this.c.a(c.SHARE_PLATFORM_QQFRIENDS);
            }
        }
    }
