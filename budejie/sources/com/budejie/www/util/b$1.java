...
class b$1 extends a<String> {
    ...
    b$1(int i, Context context, String str, Context context2, String str2) {
        this.a = i;
        this.b = context;
        this.c = str;
        this.d = context2;
    ...
    public void a(String str) {
        ...
        if (i == 0) {
            b.a().a(this.a, true, R.string.repint_success);
            a(this.b, this.b.getString(R.string.reprint_send_sccess));
        } else {
