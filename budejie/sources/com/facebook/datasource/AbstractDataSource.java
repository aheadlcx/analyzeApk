...
public abstract class AbstractDataSource<T> implements DataSource<T> {
    @GuardedBy("this")
    private AbstractDataSource$DataSourceStatus mDataSourceStatus = AbstractDataSource$DataSourceStatus.IN_PROGRESS;
    @GuardedBy("this")
    ...
    private void notifyDataSubscriber(DataSubscriber<T> dataSubscriber, Executor executor, boolean z, boolean z2) {
        executor.execute(new AbstractDataSource$1(this, z, dataSubscriber, z2));
    }
