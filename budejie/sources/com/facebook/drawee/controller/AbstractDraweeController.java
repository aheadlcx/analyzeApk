...
public abstract class AbstractDraweeController<T, INFO> implements Releasable, ClickListener, DraweeController {
    ...
    public void addControllerListener(ControllerListener<? super INFO> controllerListener) {
        ...
        if (this.mControllerListener instanceof AbstractDraweeController$InternalForwardingListener) {
            ((AbstractDraweeController$InternalForwardingListener) this.mControllerListener).addListener(controllerListener);
        } else if (this.mControllerListener != null) {
            this.mControllerListener = AbstractDraweeController$InternalForwardingListener.createInternal(this.mControllerListener, controllerListener);
        } else {
    ...
    public void removeControllerListener(ControllerListener<? super INFO> controllerListener) {
        Preconditions.checkNotNull(controllerListener);
        if (this.mControllerListener instanceof AbstractDraweeController$InternalForwardingListener) {
            ((AbstractDraweeController$InternalForwardingListener) this.mControllerListener).removeListener(controllerListener);
    ...
    protected void submitRequest() {
        ...
        this.mDataSource.subscribe(new AbstractDraweeController$1(this, this.mId, this.mDataSource.hasResult()), this.mUiThreadImmediateExecutor);
    }
    ...
    private void logMessageAndImage(String str, T t) {
        if (FLog.isLoggable(2)) {
            FLog.v(TAG, "controller %x %s: %s: image: %s %x", new Object[]{Integer.valueOf(System.identityHashCode(this)), this.mId, str, getImageClass(t), Integer.valueOf(getImageHash(t))});
        }
    }
