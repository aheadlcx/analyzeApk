...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
        ...
        if (size > 0) {
            if (genericDraweeHierarchyBuilder.getOverlays() != null) {
                for (Drawable buildBranch : genericDraweeHierarchyBuilder.getOverlays()) {
                    int i3 = i2 + 1;
                    drawableArr[i2 + 6] = buildBranch(buildBranch, null);
                    i2 = i3;
                }
            } else {
                i2 = 1;
    ...
    @Nullable
    private Drawable buildActualImageBranch(Drawable drawable, @Nullable ScalingUtils$ScaleType scalingUtils$ScaleType, @Nullable PointF pointF, @Nullable ColorFilter colorFilter) {
    ...
    public void setFailureImage(Drawable drawable, ScalingUtils$ScaleType scalingUtils$ScaleType) {
        setChildDrawableAtIndex(5, drawable);
        getScaleTypeDrawableAtIndex(5).setScaleType(scalingUtils$ScaleType);
    }
    ...
    public void setRetryImage(Drawable drawable, ScalingUtils$ScaleType scalingUtils$ScaleType) {
        setChildDrawableAtIndex(4, drawable);
        getScaleTypeDrawableAtIndex(4).setScaleType(scalingUtils$ScaleType);
    }
    ...
    public void setProgressBarImage(Drawable drawable, ScalingUtils$ScaleType scalingUtils$ScaleType) {
        setChildDrawableAtIndex(3, drawable);
        getScaleTypeDrawableAtIndex(3).setScaleType(scalingUtils$ScaleType);
    }
