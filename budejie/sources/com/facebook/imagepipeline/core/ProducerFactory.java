...
public class ProducerFactory {
    ...
    public MediaVariationsFallbackProducer newMediaVariationsProducer(Producer<EncodedImage> producer) {
        return new MediaVariationsFallbackProducer(this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCacheKeyFactory, this.mMediaVariationsIndex, this.mMediaIdExtractor, producer);
    }
