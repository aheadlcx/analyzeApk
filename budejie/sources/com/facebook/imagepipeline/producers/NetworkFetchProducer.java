...
public class NetworkFetchProducer implements Producer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        this.mNetworkFetcher.fetch(createFetchState, new NetworkFetchProducer$1(this, createFetchState));
    }

    private void onResponse(FetchState fetchState, InputStream inputStream, int i) throws IOException {
