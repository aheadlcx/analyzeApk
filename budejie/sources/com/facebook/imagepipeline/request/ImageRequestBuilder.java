...
public class ImageRequestBuilder {
    ...
    public ImageRequestBuilder setLowestPermittedRequestLevel(ImageRequest$RequestLevel imageRequest$RequestLevel) {
    ...
    public ImageRequestBuilder setCacheChoice(ImageRequest$CacheChoice imageRequest$CacheChoice) {
