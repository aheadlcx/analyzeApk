...
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter value(boolean z) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z ? Constants.SERVICE_SCOPE_FLAG_VALUE : HttpState.PREEMPTIVE_DEFAULT);
        return this;
    }
    ...
    public JsonWriter value(Boolean bool) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(bool.booleanValue() ? Constants.SERVICE_SCOPE_FLAG_VALUE : HttpState.PREEMPTIVE_DEFAULT);
        return this;
    }
