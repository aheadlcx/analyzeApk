...
public interface IPullToRefresh<T extends View> {
    ...
    void setOnRefreshListener(PullToRefreshBase$OnRefreshListener2<T> pullToRefreshBase$OnRefreshListener2);

    void setOnRefreshListener(PullToRefreshBase$OnRefreshListener<T> pullToRefreshBase$OnRefreshListener);
