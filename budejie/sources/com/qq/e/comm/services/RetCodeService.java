...
public class RetCodeService {
    ...
    static /* synthetic */ void a(RetCodeService retCodeService, RetCodeInfo retCodeInfo, int i) {
        ...
        if (retCodeService.a(i)) {
            ...
            plainRequest.addQuery("domain", retCodeInfo.a);
            plainRequest.addQuery("cgi", retCodeInfo.b);
            plainRequest.addQuery("type", String.valueOf(retCodeInfo.h));
            plainRequest.addQuery(CheckCodeDO.CHECKCODE_USER_INPUT_KEY, String.valueOf(retCodeInfo.d));
            plainRequest.addQuery(AppLinkConstants.TIME, String.valueOf(retCodeInfo.e));
