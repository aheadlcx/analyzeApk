...
class d {
    ...
    public static Process a(Process process, String[] strArr, a aVar, boolean z, boolean z2) {
        if (process == null) {
            process = z ? Runtime.getRuntime().exec("su") : Runtime.getRuntime().exec(IXAdRequestInfo.SCREEN_HEIGHT);
        }
