...
public class c {
    ...
    /* renamed from: a */
    private com.ta.utdid2.c.a.c f67a = null;
    /* renamed from: a */
    private d f68a = null;
    /* renamed from: a */
    private Pattern f69a = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    public c(Context context) {
        ...
        this.f67a = new com.ta.utdid2.c.a.c(context, ".DataStorage", "ContextData", false, true);
        this.f68a = new d();
    ...
    private void g(String str) {
        if (str != null && this.f67a != null && !str.equals(this.f67a.getString(this.m))) {
            this.f67a.putString(this.m, str);
            this.f67a.commit();
        }
    }
    ...
    private String g() {
        if (this.b != null) {
            ...
            if (!(i.a(string) || this.f68a.a(string) == null)) {
                return string;
            }
        }
        return null;
    ...
    private boolean b(String str) {
        ...
        if (24 != str.length() || this.f69a.matcher(str).find()) {
            return false;
        }
        return true;
    }
    ...
    public synchronized String h() {
        ...
        if (!b(str)) {
            ...
            if (b(str)) {
                ...
                string = this.f67a.getString(this.m);
                if (!i.a(string)) {
                    str = eVar.b(string);
                    if (!b(str)) {
                        str = this.f68a.b(string);
                    }
                    if (b(str)) {
                        string = this.f68a.a(str);
                        if (!i.a(str)) {
                            this.l = str;
                            if (obj != null) {
                                j(string);
