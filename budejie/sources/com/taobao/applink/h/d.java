...
public class d {
    ...
    private void a() {
        ...
        stringBuffer.append("logtype=2&wappkey=").append(this.d).append("&").append("packagename=").append(a.a(TBAppLinkUtil.getApplication())).append("&").append("os=").append(AlibcConstants.PF_ANDROID).append("&").append("imei=").append(this.a).append("&t=").append(System.currentTimeMillis()).append("&type=");
        if (this.c.size() > 0) {
