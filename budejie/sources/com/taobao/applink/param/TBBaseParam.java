...
public abstract class TBBaseParam {
    ...
    public String getExtraAplus() {
        ...
        stringBuffer.append(MODULE).append(LoginConstants.EQUAL).append((String) this.mParams.get(MODULE)).append("&clientType=").append(this.linkKey == null ? TBAppLinkUtil.TAOBAO_SCHEME : this.linkKey);
    ...
    protected String getH5URL(String str) throws TBAppLinkException {
            ...
            for (Entry entry : this.mExtraParams.entrySet()) {
                if (!(e.a((String) entry.getKey()) || e.a((String) entry.getValue()))) {
                    try {
                        ...
                        stringBuffer.append(encode).append(LoginConstants.EQUAL).append(URLEncoder.encode((String) entry.getValue(), "UTF-8")).append("&");
                    } catch (Throwable th) {
        ...
        if (!e.a((String) this.mParams.get("TTID"))) {
            try {
                ...
                stringBuffer.append(encode).append(LoginConstants.EQUAL).append(URLEncoder.encode((String) this.mParams.get("TTID"), "UTF-8")).append("&");
            } catch (Throwable th2) {
        ...
        if (!e.a((String) this.mParams.get("tag"))) {
            try {
                ...
                stringBuffer.append(encode).append(LoginConstants.EQUAL).append(URLEncoder.encode((String) this.mParams.get("tag"), "UTF-8")).append("&");
        ...
        if (!e.a((String) this.mParams.get("utdid"))) {
            try {
                ...
                stringBuffer.append(encode).append(LoginConstants.EQUAL).append(URLEncoder.encode((String) this.mParams.get("utdid"), "UTF-8")).append("&");
        ...
        if (!e.a((String) this.mParams.get("source"))) {
            try {
                ...
                stringBuffer.append(encode).append(LoginConstants.EQUAL).append(URLEncoder.encode((String) this.mParams.get("source"), "UTF-8")).append("&");
    ...
    public String getJumpUrl(Context context) throws TBAppLinkException {
        ...
        if (!TextUtils.isEmpty(jSONObject.toString())) {
            stringBuffer.append("params").append(LoginConstants.EQUAL).append(jSONObject.toString()).append("&");
        }
