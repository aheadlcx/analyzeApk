    ...
    public static String a(g.b bVar) {
        ...
        for (ScanResult scanResult : a) {
            if ((scanResult.level < (a.size() < 6 ? -95 : -90) ? null : 1) != null) {
                ...
                stringBuilder.append("\"rssi\":").append(scanResult.level).append(h.d);
                i++;
            }
        }
        stringBuilder.append("]");
