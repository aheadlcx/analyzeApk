...
public class TDialog extends b {
    ...
    private static class OnTimeListener implements IUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            g.a().a(this.mAction + UserTrackerConstants.U_H5, SystemClock.elapsedRealtime(), 0, 0, jSONObject.optInt(KEYS.RET, -6), this.mUrl, false);
            if (this.mWeakL != null) {
        ...
        public void onError(UiError uiError) {
            g.a().a(this.mAction + UserTrackerConstants.U_H5, SystemClock.elapsedRealtime(), 0, 0, uiError.errorCode, uiError.errorMessage != null ? uiError.errorMessage + this.mUrl : this.mUrl, false);
            if (this.mWeakL != null) {
