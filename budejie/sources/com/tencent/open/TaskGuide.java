...
public class TaskGuide extends BaseApi {
    private static int L = ErrorCode.SERVER_OPERATIONTYPEMISSED;
    static long b = 5000;
    private static Drawable k;
    private static Drawable l;
    private static Drawable m;
    private static int n = 75;
    private static int o = R$styleable.Theme_Custom_follow_divider_vertical;
    ...
    private class d extends a {
        ...
        public void onComplete(JSONObject jSONObject) {
            ...
            try {
                ...
                str = jSONObject.getString(com.baidu.mobads.openad.c.b.EVENT_MESSAGE);
                ...
                if (i == 0) {
                    ...
                    this.c.b(this.b);
                    this.c.d((int) ErrorCode.SERVER_SESSIONSTATUS);
                }
                this.c.a(this.b, k.NORAML);
                this.c.a(str);
                jSONObject2 = new JSONObject();
                try {
                    jSONObject2.put(com.alipay.sdk.util.j.c, "金券领取失败");
            ...
            if (this.c.g != null) {
                this.c.g.post(new Runnable(this) {
                    ...
                    public void run() {
                        ...
                        this.b.c.b(this.b.b);
                        this.b.c.d((int) ErrorCode.SERVER_SESSIONSTATUS);
                    }
                });
            }
        }
    ...
    private class e extends RelativeLayout {
        ...
        public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            ...
            this.b.d((int) ErrorCode.SERVER_OPERATIONTYPEMISSED);
    ...
    private static class h {
        ...
        static h a(JSONObject jSONObject) throws JSONException {
            ...
            for (int i = 0; i < length; i++) {
                ...
                hVar.c[i] = new g(jSONObject2.getInt("step_no"), jSONObject2.getString("step_desc"), jSONObject2.getString("step_gift"), jSONObject2.getLong(x.X), jSONObject2.getInt("status"));
            }
            return hVar;
        }
    }
    ...
    private class i extends LinearLayout {
        ...
        private void a() {
            ...
            this.b.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(R$styleable.Theme_Custom_top_navigation_middle, 211, 199));
            this.b.setGravity(3);
            ...
            this.c.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(R$styleable.Theme_Custom_top_navigation_middle, 211, 199));
            ...
            switch (kVar) {
                ...
                case NORAML:
                    if (this.d.e == 1) {
                        ...
                        this.c.setTextColor(Color.rgb(255, R$styleable.Theme_Custom_top_audit_btn_bg, 0));
                        this.c.setEnabled(false);
                        return;
                    } else if (this.d.e == 2) {
                        this.c.setText("领取奖励");
    ...
    private void i() {
        if (this.G) {
            d((int) ErrorCode.SERVER_OPERATIONTYPEMISSED);
        } else {
            removeWindow();
        }
        if (this.G) {
    ...
    public void showTaskGuideWindow(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        bundle2.putString(com.alipay.sdk.app.statistic.c.d, "mobile");
