...
public class e extends AsyncTask<Bitmap, Void, HashMap<String, Object>> {
    ...
    protected HashMap<String, Object> a(Bitmap... bitmapArr) {
        ...
        try {
            ...
            if (bitmap != null) {
                Object b;
                String str = "";
                if (bitmap.getWidth() > R$styleable.Theme_Custom_last_refresh_item_text_theme || bitmap.getHeight() > R$styleable.Theme_Custom_last_refresh_item_text_theme) {
                    Bitmap a = a(bitmap);
                    b = b(a);
                    a.recycle();
                } else {
    ...
    private Bitmap a(Bitmap bitmap) {
        ...
        int a = a(options, R$styleable.Theme_Custom_last_refresh_item_text_theme, R$styleable.Theme_Custom_last_refresh_item_text_theme);
        if (a > 0) {
            i = a;
        }
