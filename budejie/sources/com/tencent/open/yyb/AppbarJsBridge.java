...
public class AppbarJsBridge {
                    ...
                    for (int i2 = 0; i2 < length; i2++) {
                        ...
                        if (jSONObject2 != null) {
                            ...
                            while (keys.hasNext()) {
                                ...
                                stringBuilder.append(str3).append(LoginConstants.EQUAL).append(Uri.encode(Uri.decode(jSONObject2.getString(str3)))).append("&");
                            }
                        }
    ...
    public void ready() {
        response(READY_CALLBACK_FUNCTION_NAME, 1, null, Constants.SERVICE_SCOPE_FLAG_VALUE);
    }
    ...
    public void responseFail(String str, int i, String str2, int i2) {
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                jSONObject.put(CheckCodeDO.CHECKCODE_USER_INPUT_KEY, i2);
                jSONObject.put("method", str2);
                jSONObject.put("seqid", i);
                callback(str, jSONObject.toString());
            } catch (Exception e) {
