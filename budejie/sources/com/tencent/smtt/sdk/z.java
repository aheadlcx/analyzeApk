...
class z extends WebViewClient {
    ...
    private class e implements WebResourceRequest {
        ...
        public e(z zVar, String str, boolean z, boolean z2, String str2, Map<String, String> map) {
            this.a = zVar;
            this.b = str;
            this.c = z;
            this.d = z2;
    ...
    z(WebView webView, WebViewClient webViewClient) {
        this.b = webView;
    ...
    public void onReceivedError(WebView webView, android.webkit.WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (webResourceError != null) {
            webResourceError2 = new ab(this, webResourceError);
        }
