...
public class a {
    ...
    public static final String D = "userlevel";
    public static final String a = "Android";
    public static final String b = "Android";
    public static final String c = "MobclickAgent";
    public static boolean d = true;
    public static String e = "";
    public static String f = "http://alog.umeng.com/app_logs";
    public static String g = "http://alog.umengcloud.com/app_logs";
    public static String[] h = new String[]{f, g};
