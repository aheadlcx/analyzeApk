...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Flowable<T> concat(b<? extends MaybeSource<? extends T>> bVar, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(bVar, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }
    ...
    public static <T> Flowable<T> merge(b<? extends MaybeSource<? extends T>> bVar) {
        return merge((b) bVar, Integer.MAX_VALUE);
    }
    ...
    public static <T> Flowable<T> merge(b<? extends MaybeSource<? extends T>> bVar, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(bVar, MaybeToPublisher.instance(), false, i, Flowable.bufferSize()));
    }
    ...
    public static <T> Flowable<T> mergeDelayError(b<? extends MaybeSource<? extends T>> bVar) {
        return Flowable.fromPublisher(bVar).flatMap(MaybeToPublisher.instance(), true);
    }
