                ...
                while (!this.cancelled) {
                    ...
                    if (z2 && z) {
                        ...
                        if (num == LEFT_VALUE) {
                            ...
                            try {
                                observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.rightEnd.apply(poll2), "The rightEnd returned a null ObservableSource");
                                ...
                                for (UnicastSubject onComplete2 : this.lefts.values()) {
                            ...
                            LeftRightEndObserver leftRightEndObserver3 = (LeftRightEndObserver) poll2;
                            ...
                            LeftRightEndObserver leftRightEndObserver4 = (LeftRightEndObserver) poll2;
