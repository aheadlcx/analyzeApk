...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
            ...
            do {
                ...
                if (length != 0) {
                    ...
                    if (length == 1) {
                        ...
                        obj = new InnerDisposable[(length - 1)];
                        System.arraycopy(innerDisposableArr, 0, obj, 0, i);
                        System.arraycopy(innerDisposableArr, i + 1, obj, i, (length - i) - 1);
                    }
                } else {
                    return;
                }
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        do {
            ...
            publishObserver = new PublishObserver(this.current);
        } while (!this.current.compareAndSet(observer, publishObserver));
