...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.s, disposable)) {
                ...
                if (!this.cancelled) {
                    ...
                    DisposableHelper.replace(this.timer, schedulePeriodically);
                }
            }
        }
            ...
            while (!this.terminated) {
                ...
                if (z && (obj != null || z2)) {
                    ...
                    if (this.restartTimerOnMaxSize || this.producerIndex == consumerIndexHolder.index) {
                        unicastSubject.onComplete();
                        this.count = 0;
                        r0 = UnicastSubject.create(this.bufferSize);
                        this.window = r0;
                        observer.onNext(r0);
                        unicastSubject = r0;
                    }
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
        ...
        WindowSkipObserver(Observer<? super Observable<T>> observer, long j, long j2, TimeUnit timeUnit, Scheduler$Worker scheduler$Worker, int i) {
            super(observer, new MpscLinkedQueue());
            this.timespan = j;
            this.timeskip = j2;
            this.unit = timeUnit;
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (th != null) {
                        ...
                        for (UnicastSubject onError2 : list) {
                            onError2.onComplete();
                        }
                    }
                    disposeWorker();
