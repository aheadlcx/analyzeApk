...
public class j extends ab {
    ...
    private int i;
    private int j;
    private float[] k = new float[]{0.0f, 0.0f, 0.0f};
    private float[] l = new float[]{0.0f, 0.0f, 0.0f};
    private float[] m = new float[]{0.0f, 0.0f, 0.0f};
    ...
    public void a() {
        super.a();
        this.g = GLES20.glGetUniformLocation(l(), "shadowsShift");
        this.h = GLES20.glGetUniformLocation(l(), "midtonesShift");
        this.i = GLES20.glGetUniformLocation(l(), "highlightsShift");
        this.j = GLES20.glGetUniformLocation(l(), "preserveLuminosity");
    }
