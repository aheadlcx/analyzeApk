...
public final class h {
    ...
    public static final h X = a("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", R$styleable.Theme_Custom_new_item_login_tencent_bg);
    public static final h Y = a("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", 135);
    public static final h Z = a("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", R$styleable.Theme_Custom_new_item_shareFriend_text_color);
    ...
    public static final h aa = a("TLS_PSK_WITH_RC4_128_SHA", 138);
    public static final h ab = a("TLS_PSK_WITH_3DES_EDE_CBC_SHA", 139);
    public static final h ac = a("TLS_PSK_WITH_AES_128_CBC_SHA", R$styleable.Theme_Custom_send_btn_text_color);
    public static final h ad = a("TLS_PSK_WITH_AES_256_CBC_SHA", R$styleable.Theme_Custom_myinfo_setting_bg);
    public static final h ae = a("TLS_RSA_WITH_SEED_CBC_SHA", 150);
    public static final h af = a("TLS_RSA_WITH_AES_128_GCM_SHA256", R$styleable.Theme_Custom_bottom_navigation_posted);
    public static final h ag = a("TLS_RSA_WITH_AES_256_GCM_SHA384", R$styleable.Theme_Custom_bottom_navigation_text);
    public static final h ah = a("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", 158);
    public static final h ai = a("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", 159);
    public static final h aj = a("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", 162);
    public static final h ak = a("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", 163);
    public static final h al = a("TLS_DH_anon_WITH_AES_128_GCM_SHA256", R$styleable.Theme_Custom_label_icon_theme);
    public static final h am = a("TLS_DH_anon_WITH_AES_256_GCM_SHA384", 167);
