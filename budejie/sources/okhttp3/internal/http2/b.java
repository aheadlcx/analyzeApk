...
final class b {
    static final a[] a = new a[]{new a(a.f, ""), new a(a.c, "GET"), new a(a.c, "POST"), new a(a.d, "/"), new a(a.d, "/index.html"), new a(a.e, UriUtil.HTTP_SCHEME), new a(a.e, "https"), new a(a.b, "200"), new a(a.b, "204"), new a(a.b, "206"), new a(a.b, "304"), new a(a.b, "400"), new a(a.b, "404"), new a(a.b, "500"), new a("accept-charset", ""), new a("accept-encoding", "gzip, deflate"), new a("accept-language", ""), new a("accept-ranges", ""), new a("accept", ""), new a("access-control-allow-origin", ""), new a("age", ""), new a("allow", ""), new a("authorization", ""), new a("cache-control", ""), new a("content-disposition", ""), new a("content-encoding", ""), new a("content-language", ""), new a("content-length", ""), new a("content-location", ""), new a("content-range", ""), new a(d.d, ""), new a("cookie", ""), new a(HistoryOpenHelper.COLUMN_DATE, ""), new a("etag", ""), new a("expect", ""), new a("expires", ""), new a(UserTrackerConstants.FROM, ""), new a(c.f, ""), new a("if-match", ""), new a("if-modified-since", ""), new a("if-none-match", ""), new a("if-range", ""), new a("if-unmodified-since", ""), new a("last-modified", ""), new a("link", ""), new a(CommonStrs.TYPE_LOCATION, ""), new a("max-forwards", ""), new a("proxy-authenticate", ""), new a("proxy-authorization", ""), new a("range", ""), new a("referer", ""), new a("refresh", ""), new a("retry-after", ""), new a("server", ""), new a("set-cookie", ""), new a("strict-transport-security", ""), new a("transfer-encoding", ""), new a("user-agent", ""), new a("vary", ""), new a("via", ""), new a("www-authenticate", "")};
    ...
    static final class a {
        ...
        ByteString c() throws IOException {
            ...
            h = a(h, 127);
            if (obj != null) {
                return ByteString.of(i.a().a(this.f.f((long) h)));
            }
            return this.f.c((long) h);
        }
    }
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (num != null) {
                    ...
                    if (intValue > 1 && intValue < 8) {
                        if (okhttp3.internal.c.a(b.a[intValue - 1].h, (Object) byteString)) {
                            i2 = intValue;
                        } else if (okhttp3.internal.c.a(b.a[intValue].h, (Object) byteString)) {
                            i2 = intValue + 1;
                        }
                    }
                    i2 = -1;
                ...
                if (i2 == -1) {
                    ...
                    for (int i3 = this.d + 1; i3 < length; i3++) {
                        if (okhttp3.internal.c.a(this.c[i3].g, (Object) toAsciiLowercase)) {
                            if (okhttp3.internal.c.a(this.c[i3].h, (Object) byteString)) {
