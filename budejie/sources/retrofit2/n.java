...
final class n<R, T> {
            ...
            if (annotation instanceof x) {
                ...
                if (Map.class.isAssignableFrom(r0)) {
                    ...
                    if (r0 instanceof ParameterizedType) {
                        ...
                        return new j(this.a.c(o.a(1, r0), annotationArr), ((retrofit2.b.u) annotation).a());
                    }
                ...
                if (this.p) {
                    ...
                    r1 = o.a(type);
                    if (!a2.isEmpty()) {
                        r a3 = r.a(MIME.CONTENT_DISPOSITION, "form-data; name=\"" + a2 + "\"", MIME.CONTENT_TRANSFER_ENC, qVar.b());
                        if (Iterable.class.isAssignableFrom(r1)) {
                            if (type instanceof ParameterizedType) {
                                r0 = o.a(0, (ParameterizedType) type);
                                if (!okhttp3.v.b.class.isAssignableFrom(o.a(r0))) {
                            ...
                            if (!okhttp3.v.b.class.isAssignableFrom(r0)) {
                                return new f(a3, this.a.a(r0, annotationArr, this.c)).b();
                            }
                            throw a(i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!okhttp3.v.b.class.isAssignableFrom(r1)) {
                        ...
                        if (okhttp3.v.b.class.isAssignableFrom(r1.getComponentType())) {
                            return l.a.b();
                        }
                        throw a(i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                    } else if (okhttp3.v.b.class.isAssignableFrom(r1)) {
                ...
                if (this.p) {
                    ...
                    if (Map.class.isAssignableFrom(r0)) {
                        ...
                        if (r0 instanceof ParameterizedType) {
                            ...
                            r0 = o.a(1, r0);
                            if (!okhttp3.v.b.class.isAssignableFrom(o.a(r0))) {
                                return new g(this.a.a(r0, annotationArr, this.c), ((retrofit2.b.r) annotation).a());
                            }
    ...
    y a(Object... objArr) throws IOException {
        int length;
        int i = 0;
