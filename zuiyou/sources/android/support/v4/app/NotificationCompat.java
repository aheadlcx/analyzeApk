        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (VERSION.SDK_INT >= 24) {
                ...
                for (Message findLatestIncomingMessage2 : this.mMessages) {
                    android.app.Notification.MessagingStyle.Message message = new android.app.Notification.MessagingStyle.Message(findLatestIncomingMessage2.getText(), findLatestIncomingMessage2.getTimestamp(), findLatestIncomingMessage2.getSender());
            ...
            if (findLatestIncomingMessage2 != null) {
                ...
                if (this.mConversationTitle != null) {
                    makeMessageLine = makeMessageLine(findLatestIncomingMessage2);
                } else {
                    makeMessageLine = findLatestIncomingMessage2.getText();
                }
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    makeMessageLine = i != 0 ? makeMessageLine(findLatestIncomingMessage2) : findLatestIncomingMessage2.getText();
