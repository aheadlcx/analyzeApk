...
public final class AppCompatDrawableManager {
    ...
    L_0x009b:
        ...
        r7 = r9.mKnownDrawableIdTags;	 Catch:{ Exception -> 0x0085 }
        r7.append(r11, r0);	 Catch:{ Exception -> 0x0085 }
        r7 = r9.mDelegates;	 Catch:{ Exception -> 0x0085 }
        r0 = r7.get(r0);	 Catch:{ Exception -> 0x0085 }
        r0 = (android.support.v7.widget.AppCompatDrawableManager.InflateDelegate) r0;	 Catch:{ Exception -> 0x0085 }
        if (r0 == 0) goto L_0x00b6;
    L_0x00ae:
        r7 = r10.getTheme();	 Catch:{ Exception -> 0x0085 }
        r1 = r0.createFromXmlInner(r10, r3, r6, r7);	 Catch:{ Exception -> 0x0085 }
    L_0x00b6:
        if (r1 == 0) goto L_0x00c3;
    L_0x00b8:
        r0 = r2.changingConfigurations;	 Catch:{ Exception -> 0x0085 }
        r1.setChangingConfigurations(r0);	 Catch:{ Exception -> 0x0085 }
        r0 = r9.addDrawableToCache(r10, r4, r1);	 Catch:{ Exception -> 0x0085 }
