...
public class SoundWaveViewV2Detail extends View {
    ...
    public SoundWaveViewV2Detail(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.a = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.img_sound_wavev2detail_grey)).getBitmap();
        this.b = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.img_sound_wavev2detail_yellow)).getBitmap();
        this.c = new Rect();
        this.d = new Rect();
        this.e = new Rect();
    }
