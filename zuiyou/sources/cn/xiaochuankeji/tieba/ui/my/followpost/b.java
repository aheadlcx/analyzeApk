...
import cn.xiaochuankeji.tieba.ui.my.followpost.model.MyFollowPostModel;
...
public class b extends f implements cn.xiaochuankeji.tieba.ui.recommend.b {
    ...
    public void onViewCreated(View view, @Nullable Bundle bundle) {
        ...
        if (this.b == null) {
            this.b = new MyFollowPostAdapter(getActivity(), "myArticles");
        }
        this.a.setAdapter(this.b);
        this.c = (MyFollowPostModel) q.a((Fragment) this).a(MyFollowPostModel.class);
        this.c.a(this.b);
        if (!this.f) {
            this.c.b();
