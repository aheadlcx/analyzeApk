...
final class NioByteString extends LeafByteString {
    ...
    void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException {
        ...
        ByteBufferWriter.write(slice(i, i + i2), outputStream);
    }
    ...
    protected String toStringInternal(Charset charset) {
        ...
        if (this.buffer.hasArray()) {
            ...
            position = this.buffer.position() + this.buffer.arrayOffset();
        ...
        return new String(array, position, remaining, charset);
    }
    ...
    protected int partialIsValidUtf8(int i, int i2, int i3) {
        return Utf8.partialIsValidUtf8(i, this.buffer, i2, i2 + i3);
    }
