...
public final class UnknownFieldSet implements MessageLite {
    ...
    public static final class Builder implements com.google.protobuf.MessageLite.Builder {
        ...
        public boolean mergeFieldFrom(int i, CodedInputStream codedInputStream) throws IOException {
            ...
            switch (WireFormat.getTagWireType(i)) {
                ...
                case 2:
                    ...
                    return true;
                case 3:
                    Object newBuilder = UnknownFieldSet.newBuilder();
        ...
        public boolean mergeDelimitedFrom(InputStream inputStream) throws IOException {
            ...
            mergeFrom(new AbstractMessageLite$Builder$LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(read, inputStream)));
            return true;
        }
