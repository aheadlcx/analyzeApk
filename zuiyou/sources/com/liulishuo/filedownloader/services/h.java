...
class h {
    ...
    public synchronized boolean a(int i) {
        ...
        synchronized (this) {
            if (a() > 0) {
                ...
                int a = e.a(i);
                if (d.a) {
                    d.c(this, "change the max network thread count, from %d to %d", Integer.valueOf(this.d), Integer.valueOf(a));
                }
                List shutdownNow = this.b.shutdownNow();
                this.b = b.a(a, "Network");
    ...
    public synchronized List<Integer> b() {
        ...
        for (int i = 0; i < this.a.size(); i++) {
            arrayList.add(Integer.valueOf(((DownloadLaunchRunnable) this.a.get(this.a.keyAt(i))).d()));
        }
        return arrayList;
    }
}
