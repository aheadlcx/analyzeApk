...
public class ContentAD {
                        ...
                        try {
                            ...
                            new Handler(Looper.getMainLooper()).post(new Runnable(this) {
                                ...
                                public void run() {
                                    ...
                                    r9 = this;
                                    r8 = 1;
                                    r0 = r0;	 Catch:{ Throwable -> 0x00a9 }
                                    if (r0 == 0) goto L_0x00b8;
                                L_0x0005:
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r0;	 Catch:{ Throwable -> 0x00a9 }
                                    r2 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r2 = r5;	 Catch:{ Throwable -> 0x00a9 }
                                    r3 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r3 = r6;	 Catch:{ Throwable -> 0x00a9 }
                                    r4 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r4 = r7;	 Catch:{ Throwable -> 0x00a9 }
                                    r5 = new com.qq.e.ads.contentad.ContentAD$ADListenerAdapter;	 Catch:{ Throwable -> 0x00a9 }
                                    r6 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r6 = r6.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r7 = 0;
                                    r5.<init>();	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.getContentAdDelegate(r2, r3, r4, r5);	 Catch:{ Throwable -> 0x00a9 }
                                    r0.c = r1;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = 1;
                                    r0.h = true;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.a;	 Catch:{ Throwable -> 0x00a9 }
                                    if (r0 == 0) goto L_0x0049;
                                L_0x003a:
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.a;	 Catch:{ Throwable -> 0x00a9 }
                                    r0.setBrowserType(r1);	 Catch:{ Throwable -> 0x00a9 }
                                L_0x0049:
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.b;	 Catch:{ Throwable -> 0x00a9 }
                                ...
                                L_0x0053:
                                    ...
                                    r1 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0.setDownAPPConfirmPolicy(r1);	 Catch:{ Throwable -> 0x00a9 }
                                L_0x0062:
                                    r0 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.g;	 Catch:{ Throwable -> 0x00a9 }
                                    r2 = r0.iterator();	 Catch:{ Throwable -> 0x00a9 }
                                L_0x006e:
                                    r0 = r2.hasNext();	 Catch:{ Throwable -> 0x00a9 }
                                    if (r0 == 0) goto L_0x00b8;
                                L_0x0074:
                                    r0 = r2.next();	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = (java.util.Map) r0;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = "page_number";
                                    r1 = r0.get(r1);	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = (java.lang.Integer) r1;	 Catch:{ Throwable -> 0x00a9 }
                                    r3 = r1.intValue();	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = "channel";
                                    r1 = r0.get(r1);	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = (java.lang.Integer) r1;	 Catch:{ Throwable -> 0x00a9 }
                                    r1 = r1.intValue();	 Catch:{ Throwable -> 0x00a9 }
                                    r4 = "is_manual_operation";
                                    r0 = r0.get(r4);	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = (java.lang.Boolean) r0;	 Catch:{ Throwable -> 0x00a9 }
                                    r0 = r0.booleanValue();	 Catch:{ Throwable -> 0x00a9 }
                                    r4 = r9.b;	 Catch:{ Throwable -> 0x00a9 }
                                    r4 = r4.d;	 Catch:{ Throwable -> 0x00a9 }
                                    r4.loadAD(r3, r1, r0);	 Catch:{ Throwable -> 0x00a9 }
                                    goto L_0x006e;
                                L_0x00a9:
                                    r0 = move-exception;
                                    r1 = "Exception while init Native Core";
                                    com.qq.e.comm.util.GDTLogger.e(r1, r0);	 Catch:{ all -> 0x00c0 }
                                    r0 = r9.b;
                                    r0 = r0.d;
                                    r0.h = true;
                                L_0x00b7:
    ...
    public void loadAD(int i, int i2, boolean z) {
        if (!this.d || !this.f) {
            ...
            hashMap.put(g.b, Integer.valueOf(i2));
