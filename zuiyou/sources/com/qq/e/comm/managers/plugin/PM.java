...
public class PM {
    ...
    private boolean b() {
        ...
        r1 = 1;
        r0 = 0;
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x006e }
        r3 = "TimeStap_BEFORE_PLUGIN_INIT:";
        r2.<init>(r3);	 Catch:{ Throwable -> 0x006e }
        r4 = java.lang.System.currentTimeMillis();	 Catch:{ Throwable -> 0x006e }
        r2 = r2.append(r4);	 Catch:{ Throwable -> 0x006e }
        r2 = r2.toString();	 Catch:{ Throwable -> 0x006e }
        com.qq.e.comm.util.GDTLogger.d(r2);	 Catch:{ Throwable -> 0x006e }
        r2 = r6.c();	 Catch:{ Throwable -> 0x006e }
        if (r2 != 0) goto L_0x0026;
    L_0x001f:
        r2 = r6.h;	 Catch:{ Throwable -> 0x006e }
    ...
    L_0x003e:
        return r0;
    L_0x003f:
        r2 = r6.a;	 Catch:{ Throwable -> 0x006e }
        r3 = r6.a;	 Catch:{ Throwable -> 0x006e }
        r3 = com.qq.e.comm.managers.plugin.PM.AnonymousClass1.a(r3);	 Catch:{ Throwable -> 0x006e }
        r4 = r6.a;	 Catch:{ Throwable -> 0x006e }
        r4 = com.qq.e.comm.managers.plugin.PM.AnonymousClass1.c(r4);	 Catch:{ Throwable -> 0x006e }
        r2 = com.qq.e.comm.a.a(r2, r3, r4);	 Catch:{ Throwable -> 0x006e }
        if (r2 == 0) goto L_0x0066;
    L_0x0053:
        r2 = "xhDwn7P+cP5IyvPSSA5CYchvnnuInrl9+i8K++7ggfazNzqcRc7JLzW03wbrCsQBLB05MbIFRy/xX0kMqkVdhtiQiWXteg31NVtZaRTNxZMLkDPN7mz6nWYr4YqjvFUYwJehlz8RGsJDpgQgCz3HNlSBwVYNPKc6A//MiPxXNbk=";
        r6.b = r2;	 Catch:{ Throwable -> 0x006e }
        r2 = r6.a;	 Catch:{ Throwable -> 0x006e }
        r2 = com.qq.e.comm.managers.plugin.PM.AnonymousClass1.a(r2);	 Catch:{ Throwable -> 0x006e }
        r6.c = r2;	 Catch:{ Throwable -> 0x006e }
        r2 = 559; // 0x22f float:7.83E-43 double:2.76E-321;
        r6.d = r2;	 Catch:{ Throwable -> 0x006e }
        r2 = r1;
        goto L_0x0024;
    L_0x0066:
        r2 = "Fail to prepair Defult plugin ";
        com.qq.e.comm.util.GDTLogger.e(r2);	 Catch:{ Throwable -> 0x006e }
        r2 = r0;
        goto L_0x0024;
    L_0x006e:
        r1 = move-exception;
        r2 = "Exception while init plugin manager";
        com.qq.e.comm.util.GDTLogger.report(r2, r1);	 Catch:{ all -> 0x008d }
        r1 = new java.lang.StringBuilder;
        r2 = "TimeStap_AFTER_PLUGIN_INIT:";
        r1.<init>(r2);
        r2 = java.lang.System.currentTimeMillis();
