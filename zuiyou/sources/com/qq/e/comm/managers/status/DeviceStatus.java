...
public class DeviceStatus {
    ...
    private void a() {
        try {
            final LocationManager locationManager = (LocationManager) this.n.getSystemService(RequestParameters.SUBRESOURCE_LOCATION);
