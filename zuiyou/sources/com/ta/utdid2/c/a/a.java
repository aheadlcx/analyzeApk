...
class a implements XmlSerializer {
    ...
    private Writer f27a;
    /* renamed from: a */
    private ByteBuffer f28a = ByteBuffer.allocate(8192);
    /* renamed from: a */
    private CharsetEncoder f29a;
    /* renamed from: a */
    private final char[] f30a = new char[8192];
    private boolean f;
    private int mPos;
    ...
    private void a(String str, int i, int i2) throws IOException {
        ...
        str.getChars(i, i + i2, this.f30a, i5);
        this.mPos = i5 + i2;
    }
    ...
    private void append(char[] cArr, int i, int i2) throws IOException {
        ...
        System.arraycopy(cArr, i, this.f30a, i5, i2);
        this.mPos = i5 + i2;
    }
    ...
    private void b() throws IOException {
        int position = this.f28a.position();
        if (position > 0) {
            this.f28a.flip();
            this.f26a.write(this.f28a.array(), 0, position);
            this.f28a.clear();
        }
    }
    ...
    public void flush() throws IOException {
        if (this.mPos > 0) {
            if (this.f26a != null) {
                CharBuffer wrap = CharBuffer.wrap(this.f30a, 0, this.mPos);
                CoderResult encode = this.f29a.encode(wrap, this.f28a, true);
                while (!encode.isError()) {
                    if (encode.isOverflow()) {
                        b();
                        encode = this.f29a.encode(wrap, this.f28a, true);
                    } else {
                        b();
                        this.f26a.flush();
                    }
            ...
            this.f27a.write(this.f30a, 0, this.mPos);
            this.f27a.flush();
            this.mPos = 0;
        }
    }
    ...
    public void setOutput(OutputStream outputStream, String str) throws IOException, IllegalArgumentException, IllegalStateException {
        ...
        try {
            this.f29a = Charset.forName(str).newEncoder();
