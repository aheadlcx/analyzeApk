...
class e {
    ...
    /* renamed from: a */
    public static final HashMap m19a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a */
    public static final int[] m20a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                obj = a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return obj;
                ...
                xmlPullParser.next();
                obj = a(xmlPullParser, "list", strArr);
                strArr[0] = attributeValue;
                return obj;
            } else {
