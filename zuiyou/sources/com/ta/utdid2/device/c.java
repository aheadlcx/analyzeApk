...
public class c {
    ...
    /* renamed from: a */
    private com.ta.utdid2.c.a.c f38a = null;
    /* renamed from: a */
    private d f39a = null;
    /* renamed from: a */
    private Pattern f40a = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    public c(Context context) {
        ...
        this.f38a = new com.ta.utdid2.c.a.c(context, ".DataStorage", "ContextData", false, true);
        this.f39a = new d();
    ...
    private void g(String str) {
        if (str != null && this.f38a != null && !str.equals(this.f38a.getString(this.m))) {
            this.f38a.putString(this.m, str);
            this.f38a.commit();
        }
    }
    ...
    private String g() {
        if (this.b != null) {
            ...
            if (!(i.a(string) || this.f39a.a(string) == null)) {
                return string;
            }
        }
        return null;
    ...
    private boolean b(String str) {
        ...
        if (24 != str.length() || this.f40a.matcher(str).find()) {
            return false;
        }
        return true;
    }
    ...
    public synchronized String h() {
        ...
        if (!b(str)) {
            ...
            if (b(str)) {
                ...
                string = this.f38a.getString(this.m);
                if (!i.a(string)) {
                    str = eVar.b(string);
                    if (!b(str)) {
                        str = this.f39a.b(string);
                    }
                    if (b(str)) {
                        string = this.f39a.a(str);
                        if (!i.a(str)) {
                            this.l = str;
                            if (obj != null) {
                                j(string);
