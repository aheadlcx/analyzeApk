...
public class a {
    ...
    protected void a(StrategyBean strategyBean, boolean z) {
        an.c("[Strategy] Notify %s", new Object[]{b.class.getName()});
        b.a(strategyBean, z);
        for (com.tencent.bugly.a aVar : this.d) {
            try {
                an.c("[Strategy] Notify %s", new Object[]{aVar.getClass().getName()});
    ...
    public void a(bg bgVar) {
        if (bgVar != null) {
            if (this.g == null || bgVar.h != this.g.p) {
                ...
                if (ap.a(i) || !ap.c(i)) {
                    if (ap.c(bgVar.d)) {
                        an.c("[Strategy] Upload url changes to %s", new Object[]{bgVar.d});
                        strategyBean.r = bgVar.d;
                    }
                    if (ap.c(bgVar.e)) {
                        an.c("[Strategy] Exception upload url changes to %s", new Object[]{bgVar.e});
