...
public class c {
    ...
    protected c(int i, Context context, am amVar, boolean z, BuglyStrategy$a buglyStrategy$a, f fVar, String str) {
        a = i;
        Context a = ap.a(context);
        this.t = a;
        this.q = amVar;
        this.r = buglyStrategy$a;
        this.s = fVar;
        ak a2 = ak.a();
        ae a3 = ae.a();
        this.o = new b(i, a, a2, a3, this.p, buglyStrategy$a, fVar);
        ...
        this.w = NativeCrashHandler.getInstance(a, a4, this.o, this.p, amVar, z, str);
        a4.J = this.w;
        this.x = new b(a, this.p, a4, amVar, a3, this.o, buglyStrategy$a);
    }

    public static synchronized void a(int i, Context context, boolean z, BuglyStrategy$a buglyStrategy$a, f fVar, String str) {
        synchronized (c.class) {
            if (u == null) {
                u = new c(i, context, am.a(), z, buglyStrategy$a, fVar, str);
            }
        }
    }
    ...
    public void a(Thread thread, Throwable th, boolean z, String str, byte[] bArr, boolean z2) {
        ...
        this.q.a(new Runnable(this) {
            ...
            public void run() {
                try {
                    an.c("post a throwable %b", new Object[]{Boolean.valueOf(z3)});
                    ...
                    an.e("java catch error: %s", new Object[]{th2.toString()});
                }
            }
        });
    }
