...
public class AuthAgent extends BaseApi {
    ...
    private class a implements IUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            try {
                ...
                Object string = i == 0 ? ANConstants.SUCCESS : jSONObject.getString("msg");
                if (this.a != null) {
    ...
    private class b implements IUiListener {
        ...
        private View a(Context context, Drawable drawable, String str, OnClickListener onClickListener, OnClickListener onClickListener2) {
            ...
            imageView.setBackgroundColor(Color.rgb(Opcodes.OR_INT_LIT16, Opcodes.OR_INT_LIT16, Opcodes.OR_INT_LIT16));
            imageView.setId(3);
