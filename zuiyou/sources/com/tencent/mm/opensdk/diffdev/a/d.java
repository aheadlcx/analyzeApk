...
public final class d extends AsyncTask<Void, Void, a> {
    ...
    static class a {
        ...
        public static a a(byte[] bArr) {
            ...
            if (bArr == null || bArr.length == 0) {
                ...
                aVar.a = OAuthErrCode.WechatAuth_Err_NetworkErr;
            } else {
                try {
                    try {
                        ...
                        if (i != 0) {
                            ...
                            aVar.e = i;
                            aVar.f = jSONObject.optString("errmsg");
                        } else {
                            ...
                            if (string == null || string.length() == 0) {
                                ...
                                if (decode == null || decode.length == 0) {
                                    ...
                                    if (a(d.i, decode)) {
                                        ...
                                        Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in external storage, uuid = %s, appname = %s, imgPath = %s", new Object[]{aVar.b, aVar.c, aVar.d}));
                                    } else {
                                    ...
                                    aVar.b = jSONObject.getString("uuid");
                                    aVar.c = jSONObject.getString("appname");
                                    Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", new Object[]{aVar.b, aVar.c, Integer.valueOf(aVar.g.length)}));
                                }
                            }
                        }
                    } catch (Exception e) {
    ...
    protected final /* synthetic */ void onPostExecute(Object obj) {
        ...
        if (aVar.a == OAuthErrCode.WechatAuth_Err_OK) {
            ...
            this.m.onAuthGotQrcode(aVar.d, aVar.g);
            this.n = new f(aVar.b, this.m);
            f fVar = this.n;
        ...
        Log.e("MicroMsg.SDK.GetQRCodeTask", String.format("onPostExecute, get qrcode fail, OAuthErrCode = %s", new Object[]{aVar.a}));
        this.m.onAuthFinish(aVar.a, null);
    }
}
