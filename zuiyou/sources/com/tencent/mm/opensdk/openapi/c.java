...
final class c implements IWXAPI {
    ...
    private boolean a(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            if (d.a(queryParameter)) {
                ...
                Log.e("MicroMsg.SDK.WXApiImplV10", "handleWxInternalRespType fail, unknown resptype = " + queryParameter);
                return false;
            }
        } catch (Exception e) {
    ...
    public final boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            if (!b.a(intent, Token.WX_TOKEN_VALUE_MSG)) {
    ...
    public final boolean isWXAppInstalled() {
        ...
        try {
            ...
            if (packageInfo != null) {
                z = b.a(this.a, packageInfo.signatures, this.c);
            }
    ...
    public final boolean registerApp(String str, long j) {
        ...
        } else if (b.a(this.a, "com.tencent.mm", this.c)) {
