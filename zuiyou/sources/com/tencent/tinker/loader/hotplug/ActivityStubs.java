...
final class ActivityStubs {
    static final String a = ActivityStubs.class.getPackage().getName();
    static final String b = (a + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
    static final String c = (a + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    static final String d = (a + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final String e = (a + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
