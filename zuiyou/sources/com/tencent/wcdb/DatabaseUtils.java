...
public final class DatabaseUtils {
    ...
    public static void cursorStringToInsertHelper(Cursor cursor, String str, DatabaseUtils$InsertHelper databaseUtils$InsertHelper, int i) {
        databaseUtils$InsertHelper.bind(i, cursor.getString(cursor.getColumnIndexOrThrow(str)));
    }
