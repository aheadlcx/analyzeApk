...
public class SQLiteAsyncQuery extends SQLiteProgram {
    ...
    void acquire() {
        if (this.mPreparedStatement == null) {
            ...
            this.mPreparedStatement.a(getBindArgs());
        }
    }
    ...
    int fillRows(ChunkedCursorWindow chunkedCursorWindow, int i, int i2) {
        ...
        try {
            return nativeFillRows(this.mPreparedStatement.a(), chunkedCursorWindow.mWindowPtr, i, i2);
    ...
    int getCount() {
        acquire();
        try {
            return nativeCount(this.mPreparedStatement.a());
        } catch (SQLiteDatabaseCorruptException e) {
            onCorruption();
            throw e;
        } catch (SQLiteException e2) {
