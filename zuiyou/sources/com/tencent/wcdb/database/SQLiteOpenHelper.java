...
public abstract class SQLiteOpenHelper {
    ...
    public SQLiteOpenHelper(Context context, String str, byte[] bArr, SQLiteCipherSpec sQLiteCipherSpec, SQLiteDatabase$CursorFactory sQLiteDatabase$CursorFactory, int i, DatabaseErrorHandler databaseErrorHandler) {
        if (i < 1) {
    ...
    public SQLiteOpenHelper(Context context, String str, byte[] bArr, SQLiteDatabase$CursorFactory sQLiteDatabase$CursorFactory, int i, DatabaseErrorHandler databaseErrorHandler) {
        this(context, str, bArr, null, sQLiteDatabase$CursorFactory, i, databaseErrorHandler);
    }

    public SQLiteOpenHelper(Context context, String str, SQLiteDatabase$CursorFactory sQLiteDatabase$CursorFactory, int i, DatabaseErrorHandler databaseErrorHandler) {
        this(context, str, null, null, sQLiteDatabase$CursorFactory, i, databaseErrorHandler);
    }
