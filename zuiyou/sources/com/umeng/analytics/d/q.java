...
public class q implements h {
    ...
    public void k() {
        m.a(this.n).edit().putInt(h, this.a).putInt(i, this.b).putInt(j, this.e).putLong(k, this.c).putLong(m, this.f).commit();
    }

    public long l() {
        SharedPreferences a = m.a(this.n);
        this.g = m.a(this.n).getLong(l, 0);
        if (this.g == 0) {
