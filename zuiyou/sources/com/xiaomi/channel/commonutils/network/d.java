...
public class d {
    ...
    public static InputStream a(Context context, URL url, boolean z, String str, String str2, Map<String, String> map, b bVar) {
        if (context == null) {
            throw new IllegalArgumentException(g.aI);
        } else if (url == null) {
    ...
    public static HttpURLConnection b(Context context, URL url) {
        return !"http".equals(url.getProtocol()) ? (HttpURLConnection) url.openConnection() : b(context) ? (HttpURLConnection) url.openConnection(new Proxy(Type.HTTP, new InetSocketAddress("10.0.0.200", 80))) : (HttpURLConnection) url.openConnection();
    }
