    ...
    class c extends b {
        ...
        private boolean f() {
            ...
            try {
                ...
                currentTimeMillis = jSONObject.getLong(Statics.TIME);
            ...
            try {
                jSONObject2.put(Statics.TIME, currentTimeMillis);
        ...
        public void b() {
            try {
                if (f()) {
                    ...
                    hashMap.put("uid", az.e());
                    hashMap.put("token", this.b);
                    hashMap.put("net", d.k(this.g.b));
        ...
        public boolean d() {
            return d.e(this.g.b) || (this.f && d.c(this.g.b));
        }
    }
