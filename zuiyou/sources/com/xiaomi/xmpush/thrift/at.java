...
public class at implements Serializable, Cloneable, org.apache.thrift.a<at, a> {
    ...
    private static final org.apache.thrift.protocol.b t = new org.apache.thrift.protocol.b("topic", ByteCode.T_LONG, (short) 8);
    private static final org.apache.thrift.protocol.b u = new org.apache.thrift.protocol.b("packageName", ByteCode.T_LONG, (short) 9);
    private static final org.apache.thrift.protocol.b v = new org.apache.thrift.protocol.b("category", ByteCode.T_LONG, (short) 10);
    public String a;
    public x b;
    public String c;
    public String d;
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, as.class)));
    ...
    public boolean a(at atVar) {
        ...
        boolean a = a();
        boolean a2 = atVar.a();
        if ((a || a2) && (!a || !a2 || !this.a.equals(atVar.a))) {
            return false;
        }
        a = b();
        a2 = atVar.b();
        if ((a || a2) && (!a || !a2 || !this.b.a(atVar.b))) {
            return false;
        }
        a = c();
        a2 = atVar.c();
        if ((a || a2) && (!a || !a2 || !this.c.equals(atVar.c))) {
            return false;
        }
        a = d();
        a2 = atVar.d();
        if ((a || a2) && (!a || !a2 || !this.d.equals(atVar.d))) {
            return false;
        }
        a = e();
        a2 = atVar.e();
        if ((a || a2) && (!a || !a2 || !this.e.a(atVar.e))) {
            return false;
        }
        a = f();
        a2 = atVar.f();
        if ((a || a2) && (!a || !a2 || this.f != atVar.f)) {
            return false;
        }
        a = g();
        a2 = atVar.g();
        if ((a || a2) && (!a || !a2 || !this.g.equals(atVar.g))) {
            return false;
        }
        a = i();
        a2 = atVar.i();
        if ((a || a2) && (!a || !a2 || !this.h.equals(atVar.h))) {
            return false;
        }
        a = j();
        a2 = atVar.j();
        if ((a || a2) && (!a || !a2 || !this.i.equals(atVar.i))) {
            return false;
        }
        a = l();
        a2 = atVar.l();
        return !(a || a2) || (a && a2 && this.j.equals(atVar.j));
    }
    ...
    public int b(at atVar) {
        ...
        if (l()) {
            compareTo = org.apache.thrift.b.a(this.j, atVar.j);
            if (compareTo != 0) {
                return compareTo;
            }
        }
